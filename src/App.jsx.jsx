...
const YEAR_RELIEF = {"2022/2023":3000000,"2023/2024":3000000,"2024/2025":3000000,"2025/2026":3000000,"2026/2027":3000000};
...
function NavBar({tab,setTab,lang}){
  const tabs=[
    ...
    {id:"services", icon:"💼",key:"nav_services"},
...
function TransactionBook({data,update,cashBalance,totalBankBal,bankBalance,profile}){
  ...
  return(
    <div style={S.page}>
      ...
      <div style={S.pageHdr}><div style={S.pageTitle}>📒 Transaction Ledger</div><button style={S.addBtn} onClick={()=>{setShowForm(!showForm);setShowCustomCat(false);}}>{showForm?"✕ Cancel":"+ Add"}</button></div>
...
function IncomePage({data,update,tax,profile,incomeCats,activeYear}){
  ...
  return(
    <div style={S.page}>
      ...
      <div style={S.pageHdr}><div style={S.pageTitle}>📥 Income — {activeYear}</div><button style={S.addBtn} onClick={()=>setShowForm(!showForm)}>{showForm?"✕":"+ Add"}</button></div>
