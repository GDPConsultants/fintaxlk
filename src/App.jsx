    ...
    if("serviceWorker" in navigator){
      navigator.serviceWorker.register("/sw.js")
        .then(reg=>{
          ...
          // 2. When a new SW is found waiting → show the update banner
          const checkWaiting = () => {
            if(reg.waiting){
          ...
          // 3. If a new SW installs while page is open
      ...
      // 4. When the SW actually takes control → reload to activate new version
      navigator.serviceWorker.addEventListener("controllerchange",()=>{
        if(window.__fintaxReloading) return;
        window.__fintaxReloading = true;
        window.location.reload();
      });
    }

    // 5. Periodic check: poll for new SW every 30 minutes (user leaves tab open)
    const _swPoll = setInterval(()=>{
      if("serviceWorker" in navigator){
