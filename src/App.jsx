...
const SUBSCRIPTION_PRICE = 15000_000;
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:16}}>
            {[
              {type:"individual",icon:"👤",label:"Individual",sub:"Salaried / Freelancer",
               color:"#b8960c",border:"#b8960c",bg:"linear-gradient(135deg,#1a1200,#2a1c00)",from:"From Rs.4,800/yr"},
              {type:"company",icon:"🏢",label:"Company",sub:"Business / Corporate",
               color:"#06b6d4",border:"#0e7490",bg:"linear-gradient(135deg,#01101a,#011a28)",from:"From Rs.18,000/yr"},
            ].map(opt=>(
...
function ServicesPage({profile,lang}){
  ...
  const CURRENT_SERVICES=[
    ...
    {icon:"🧮",color:"#10b981",border:"#064e3b",bg:"linear-gradient(135deg,#010d08,#021a10)",
     title:"Tax Return Filing (AITR)",price:"Rs.5,000",desc:"We prepare and file your Annual Income Tax Return with IRD. Accuracy guaranteed — includes FREE for Pro/Premium subscribers.",
  ...
  // Additional monetisable services — accounting / tax / audit
  const ADDITIONAL_SERVICES=[
    ...
    {icon:"🧑‍💻",color:"#8b5cf6",border:"#5b21b6",bg:"linear-gradient(135deg,#0a0520,#150a3a)",
     ...
     waMsg:"Hi GDP Consultants, I'm a freelancer/IT contractor and need the Freelancer Tax Package at Rs.10,000/yr."},
    {icon:"🏭",color:"#f59e0b",border:"#92400e",bg:"linear-gradient(135deg,#1a0e00,#2a1500)",
     title:"VAT & NBT Compliance",price:"Rs.5,000/M",desc:"VAT and Nation Building Tax monthly compliance returns. We prepare, file and maintain all records on your behalf.",
     waMsg:"Hi GDP Consultants, I need help with VAT & NBT monthly compliance."},
  ];
