...
// Authorized JS origins: https://app.taxcalculator.lk AND https://app.taxcalculator.lk
const GOOGLE_CLIENT_ID = "1028598004568-84vri5p36qqarmp3oodnki3l3vqjcivp.apps.googleusercontent.com";
const DRIVE_SCOPE      = "https://www.googleapis.com/auth/drive.file";
const BACKUP_FILENAME_PREFIX = "TaxCalcLK_Backup_";
...
const TRANSLATIONS = {
  en:{
    ...
    onboard_welcome:"Welcome to TaxCalc LK",
    annual_plan:"ANNUAL PREMIUM PLAN", pay_btn:"Subscribe via Google Play",
    or_pay_online:"SUBSCRIBE NOW", processing:"⏳ Processing...",
    ...
    svc_ird:"IRD Notice Response",svc_ird_desc:"Received an IRD notice? We respond on your behalf within 24 hours. Experienced with all IRD communication types.",svc_ird_price:"Rs.5,000–10,000",
    svc_vat:"VAT Registration",svc_vat_desc:"Get your business VAT-registered with IRD. We handle all paperwork and submission.",svc_vat_price:"Rs.8,000",
    svc_aitr:"Tax Return Filing (AITR)",svc_aitr_desc:"We prepare and file your Annual Income Tax Return. Accuracy guaranteed — FREE for Pro/Premium subscribers.",svc_aitr_price:"Rs.5,000",
    svc_company:"Company Registration",svc_company_desc:"Register a private limited company end-to-end including ROC filing, Articles, and Secretary appointment.",svc_company_price:"Rs.15,000",
    svc_audit:"Statutory Audit Certificate",svc_audit_desc:"Statutory audit certificate for your business. Required by banks, government tenders, and regulatory filings.",svc_audit_price:"From Rs.25,000",
    svc_amended:"Amended Tax Return",svc_amended_desc:"Fix errors in a previously filed tax return. We liaise with IRD for correction and resubmission.",svc_amended_price:"Rs.5,000",
    svc_payroll:"Payroll / APIT Management",svc_payroll_desc:"Monthly APIT payroll for you and your employees. Includes deduction schedules, PAYE returns, and EPF/ETF remittances.",svc_payroll_price:"Rs.2,000/emp/mo",
    svc_mgmt:"Management Accounts",svc_mgmt_desc:"Quarterly management accounts: P&L, Balance Sheet, and cash flow statement for your business decision-making.",svc_mgmt_price:"Rs.8,000/qtr",
    svc_tp:"Transfer Pricing Documentation",svc_tp_desc:"Mandatory TP documentation for related-party transactions under IRD Ruling 2024/01. Protects against reassessment.",svc_tp_price:"From Rs.35,000",
    svc_rental_adv:"Rental Income Tax Advisory",svc_rental_adv_desc:"Optimise tax on rental income: allowable deductions, assessable income calculation, and withholding tax guidance.",svc_rental_adv_price:"Rs.3,500",
    svc_wht:"Investment & WHT Refund",svc_wht_desc:"Claim back overpaid withholding tax on FD interest, dividends. We compute the refund and file on your behalf.",svc_wht_price:"Rs.4,000",
    svc_foreign:"Export / Foreign Income Tax",svc_foreign_desc:"15% flat tax on service exports & foreign-sourced income (Act No.2/2025). We compute, plan and file correctly.",svc_foreign_price:"Rs.6,000",
    svc_dd:"Due Diligence Review",svc_dd_desc:"Financial due diligence for acquisitions, investments or partnerships. Review of books, tax compliance and liabilities.",svc_dd_price:"From Rs.40,000",
    svc_bv:"Business Valuation Report",svc_bv_desc:"Professional valuation using DCF, market multiples and asset-based approaches. Required for bank loans and M&A.",svc_bv_price:"From Rs.30,000",
    svc_ia:"Internal Audit & Controls",svc_ia_desc:"Review of internal controls and risk management. Identify gaps before the statutory auditor does.",svc_ia_price:"From Rs.20,000",
    svc_cos:"Company Secretarial Services",svc_cos_desc:"Annual returns, board resolutions, AGM filing, share transfers and ROC compliance maintained monthly.",svc_cos_price:"Rs.3,000/mo",
    svc_pkg_fl:"Freelancer Tax Package",svc_pkg_fl_desc:"Complete freelancer/IT contractor tax solution: quarterly advance tax, AITR filing, foreign income reporting, and 1hr advisory.",svc_pkg_fl_price:"Rs.8,000/yr",
    svc_escnbt:"ESC / NBT Compliance",svc_escnbt_desc:"Economic Service Charge and Nation Building Tax returns (legacy obligations). We review prior-year exposures.",svc_escnbt_price:"Rs.5,000",
    ...
    tier_basic:"Basic",tier_pro:"Pro",tier_biz:"Premium",
    tier_basic_price:"Rs.4,800/yr",tier_pro_price:"Rs.12,000/yr",tier_biz_price:"Rs.24,000/yr",
    tier_basic_desc:"App only — self-service calculations",tier_pro_desc:"App + FREE AITR filing + 1hr consultation",tier_biz_desc:"App + quarterly reviews + full tax support",
    tier_starter:"Starter",tier_business:"Business",tier_enterprise:"Enterprise",
    tier_starter_price:"Rs.18,000/yr",tier_business_price:"Rs.36,000/yr",tier_enterprise_price:"Rs.60,000/yr",
  ...
  si:{
    ...
    onboard_welcome:"TaxCalc LK වෙත සාදරයෙන් පිළිගනිමු",
    annual_plan:"වාර්ෂික ප්‍රිමියම් සැලැස්ම", pay_btn:"Google Play හරහා දායකත්වය ලබා ගන්න",
    or_pay_online:"දායකත්වය", processing:"⏳ සකසමින්...",
    ...
    nav_services:"අපගේ සේවා",    services_title:"CA සේවා",services_subtitle:"GDP Consultants හරහා WhatsApp ඔස්සේ වෙන්කර ගන්න",
    ...
    svc_aitr:"AITR ගොනු කිරීම",svc_aitr_desc:"ඔබේ ආදායම් බදු ප්‍රතිලාභය ගොනු කරමු. Pro/Premium සඳහා නොමිලේ.",svc_aitr_price:"රු.5,000",
    svc_company:"සමාගම් ලියාපදිංචිය",svc_company_desc:"පෞද්ගලික සීමිත සමාගමක් ලියාපදිංචි කරන්න.",svc_company_price:"රු.15,000",
    svc_audit:"ව්‍යවස්ථාපිත විගණන සහතිකය",svc_audit_desc:"ව්‍යාපාරය සඳහා ව්‍යවස්ථාපිත විගණනය.",svc_audit_price:"රු.25,000 සිට",
    ...
    svc_mgmt:"කළමනාකරණ ගිණුම්",svc_mgmt_desc:"කාර්තු කළමනාකරණ ගිණුම්: ලාභය/අලාභය, ශේෂ පත්‍රය.",svc_mgmt_price:"රු.8,000/කාර්තු",
    svc_tp:"Transfer Pricing Documentation",svc_tp_desc:"IRD Ruling 2024/01 යටතේ අවශ්‍ය TP ලේඛනගත කිරීම.",svc_tp_price:"රු.35,000 සිට",
    svc_rental_adv:"කුලී ආදායම් උපදේශනය",svc_rental_adv_desc:"කුලී ආදායම් බදු ප්‍රශස්ත කිරීම.",svc_rental_adv_price:"රු.3,500",
    svc_wht:"WHT ප්‍රතිලාභ",svc_wht_desc:"FD, ලාභාංශ WHT ආපසු ලබා ගන්න.",svc_wht_price:"රු.4,000",
    svc_foreign:"විදේශ ආදායම් බදු",svc_foreign_desc:"සේවා අපනයන 15% flat tax. Act No.2/2025.",svc_foreign_price:"රු.6,000",
    svc_dd:"Due Diligence",svc_dd_desc:"අත්පත් කර ගැනීම් සඳහා මූල්‍ය Due Diligence.",svc_dd_price:"රු.40,000 සිට",
    svc_bv:"ව්‍යාපාර වටිනාකම් වාර්තාව",svc_bv_desc:"DCF, market multiples භාවිතා කරමින් වෘත්තීය වටිනාකම් නිර්ණය.",svc_bv_price:"රු.30,000 සිට",
    svc_ia:"අභ්‍යන්තර විගණනය",svc_ia_desc:"අභ්‍යන්තර පාලන සමාලෝචනය.",svc_ia_price:"රු.20,000 සිට",
    svc_cos:"Company Secretarial",svc_cos_desc:"වාර්ෂික ප්‍රතිලාභ, ROC අනුකූලතාව.",svc_cos_price:"රු.3,000/මාසය",
    svc_pkg_fl:"Freelancer Tax Package",svc_pkg_fl_desc:"Freelancer/IT contractor සම්පූර්ණ බදු විසඳුම.",svc_pkg_fl_price:"රු.8,000/වර්ෂ",
    svc_escnbt:"ESC / NBT",svc_escnbt_desc:"ESC සහ NBT ප්‍රතිලාභ (legacy). පෙර වර්ෂ ආවරණය.",svc_escnbt_price:"රු.5,000",
  ...
  ta:{
    ...
    onboard_welcome:"TaxCalc LK-க்கு வரவேற்கிறோம்",
    annual_plan:"வருடாந்திர பிரீமியம் திட்டம்", pay_btn:"Google Play வழி சந்தா செய்யவும்",
    or_pay_online:"சந்தா", processing:"⏳ செயலாக்கம்...",
    ...
    svc_aitr:"AITR தாக்கல்",svc_aitr_desc:"வருமான வரி தாக்கல். Pro/Premium இலவசம்.",svc_aitr_price:"ரூ.5,000",
    svc_company:"நிறுவன பதிவு",svc_company_desc:"தனியார் நிறுவனம் பதிவு செய்யவும்.",svc_company_price:"ரூ.15,000",
    svc_audit:"சட்டபூர்வ தணிக்கை சான்றிதழ்",svc_audit_desc:"சட்டபூர்வ தணிக்கை சான்றிதழ்.",svc_audit_price:"ரூ.25,000 முதல்",
    ...
    svc_payroll:"சம்பளப்பட்டியல் / APIT",svc_payroll_desc:"ஊழியர்களுக்கான மாதாந்திர APIT.",svc_payroll_price:"ரூ.2,000/ஊழியர்/மாதம்",
    svc_mgmt:"மேலாண்மை கணக்குகள்",svc_mgmt_desc:"காலாண்டு மேலாண்மை கணக்குகள்.",svc_mgmt_price:"ரூ.8,000/காலாண்டு",
    svc_tp:"Transfer Pricing",svc_tp_desc:"IRD Ruling 2024/01 TP ஆவணங்கள்.",svc_tp_price:"ரூ.35,000 முதல்",
    svc_rental_adv:"வாடகை வருமான ஆலோசனை",svc_rental_adv_desc:"வாடகை வருமான வரி மேம்படுத்தல்.",svc_rental_adv_price:"ரூ.3,500",
    svc_wht:"WHT திரும்பப் பெறல்",svc_wht_desc:"FD, பங்குகள் WHT திரும்பப் பெறல்.",svc_wht_price:"ரூ.4,000",
    svc_foreign:"வெளிநாட்டு வருமான வரி",svc_foreign_desc:"ஏற்றுமதி/வெளிநாட்டு வருமானம் 15% flat tax.",svc_foreign_price:"ரூ.6,000",
    svc_dd:"Due Diligence",svc_dd_desc:"கையகப்படுத்தல் நிதி Due Diligence.",svc_dd_price:"ரூ.40,000 முதல்",
    svc_bv:"வணிக மதிப்பீட்டு அறிக்கை",svc_bv_desc:"DCF மற்றும் சந்தை பன்மடங்குகள் மதிப்பீடு.",svc_bv_price:"ரூ.30,000 முதல்",
    svc_ia:"உள் தணிக்கை",svc_ia_desc:"உள் கட்டுப்பாடுகள் மதிப்பாய்வு.",svc_ia_price:"ரூ.20,000 முதல்",
    svc_cos:"Company Secretarial",svc_cos_desc:"ஆண்டு வருமானம், ROC இணக்கம்.",svc_cos_price:"ரூ.3,000/மாதம்",
    svc_pkg_fl:"Freelancer Tax Package",svc_pkg_fl_desc:"Freelancer/IT contractor வரி தீர்வு.",svc_pkg_fl_price:"ரூ.8,000/ஆண்டு",
    svc_escnbt:"ESC / NBT",svc_escnbt_desc:"ESC மற்றும் NBT (legacy) இணக்கம்.",svc_escnbt_price:"ரூ.5,000",
...
const DEFAULT_SUBSCRIPTION_PRICE = 12_000;
const FREE_TRIAL_DAYS     = 30;
const ADMIN_PRICING_KEY   = "fintax_admin_pricing"; // shared storage key
const ADMIN_SUBSCRIBERS_KEY = "fintax_subscribers";  // shared storage key for subscriber list

// GDP Consultants Bank Details for manual payment
const BANK_DETAILS = {
  accountName:  "GDP CONSULTANTS",
  accountNo:    "101914037651",
  bank:         "Sampath Bank PLC",
  address:      "No:110, Sir James Peiris Mawatha, Colombo 02, Sri Lanka",
  swiftCode:    "BSAMLKLX",
};
// Computed at runtime — may be overridden by admin via shared storage
...
// ═══════════════════════════════════════════════════════════════════════════════
// TAX YEAR CONFIGURATION — VERIFIED FROM IRD OFFICIAL SOURCES
// Sources:
//   • Inland Revenue Act No.24 of 2017 (IRA)
//   • Inland Revenue (Amendment) Act No.45 of 2022  — certified 09.12.2022
//   • Inland Revenue (Amendment) Act No.04 of 2023  — effective 01.04.2023
//   • Inland Revenue (Amendment) Act No.14 of 2023
//   • Inland Revenue (Amendment) Act No.02 of 2025  — certified 20.03.2025
//   • IRD Notice PN/IT/2022-03 dated 15.12.2022
//   • IRD Notice PN/APIT/2022-01 dated 20.12.2022
//   • IRD Notice PN/IT/2025-01 dated 26.03.2025
//   • APIT Table 01 (2025/2026) — ird.gov.lk
//   • SET Guides 2022/23, 2023/24, 2024/25 — ird.gov.lk
// ═══════════════════════════════════════════════════════════════════════════════
const TAX_YEAR_CONFIG = {

  // ══════════════════════════════════════════════════════════════════════════════
  // ── 2022/2023 ── SPLIT YEAR (Two distinct tax regimes)
  // ══════════════════════════════════════════════════════════════════════════════
  // PERIOD 1:  01.04.2022 – 31.12.2022  (9 months) — IRA No.24/2017 rates
  //   Personal Relief:    Rs.2,250,000  (for 9-month period, = Rs.250,000/month)
  //   Expenditure Relief: Rs.900,000    (for 9-month period, = Rs.100,000/month)
  //   Total Relief P1:    Rs.3,150,000  (personal + expenditure for the period)
  //   APIT monthly threshold: Rs.250,000/month
  //   Tax bands (on taxable income for the period):
  //     First Rs.2,250,000 → 6%
  //     Next  Rs.2,250,000 → 12%
  //     Balance             → 18%
  //   AIT on interest:    6% (before Amendment 45/2022)
  //   WHT on dividends:   12%
  //
  // PERIOD 2:  01.01.2023 – 31.03.2023  (3 months) — Amendment Act No.45/2022
  //   Personal Relief:    Rs.300,000    (for 3-month period, = Rs.100,000/month)
  //   Expenditure Relief: Not applicable
  //   APIT mandatory from 01.01.2023 regardless of employee consent
  //   APIT monthly threshold: Rs.100,000/month
  //   Tax bands (on taxable income for the period):
  //     First Rs.125,000 → 6%   |  Next Rs.125,000 → 12%  |  Next Rs.125,000 → 18%
  //     Next  Rs.125,000 → 24%  |  Next Rs.125,000 → 30%  |  Balance           → 36%
  //   AIT on interest:    5% (mandatory from 01.01.2023 — Amendment No.45/2022)
  //   WHT on dividends:   15% (final withholding from 01.01.2023)
  //
  // Source: PN/IT/2022-03 (15.12.2022) | PN/APIT/2022-01 (20.12.2022)
  // ══════════════════════════════════════════════════════════════════════════════
  "2022/2023": {
    // ── FULL YEAR total personal relief (both periods combined — for AITR filing)
    // Source: IRD Return Guide 2022/2023 (Asmt_IIT_004_2022_2023_E.pdf) — confirmed
    // "Rs. 2,250,000 and Rs. 300,000 relevant to the First Period and the Second Period
    //  respectively shall be deducted"  i.e.  Rs.2,250,000 + Rs.300,000 = Rs.2,550,000
    personalRelief:         2_550_000,  // ✅ CORRECTED: Period 1 (Rs.2,250,000) + Period 2 (Rs.300,000)
    qpCap:                  1_200_000,
    maxRefund:                180_000,
    filingThreshold:          3_000_000, // ✅ CORRECTED: Annual assessable income threshold for SET/AITR (old rules)
    exportRate:                  0.00,  // ✅ EXEMPT — IT/service export exemption removed only from 01.04.2023
    exportExempt:                true,  // s.9(1)(q) exemption still in force for Y/A 2022/2023
    aitRate:                     0.05,  // Period 2 AIT on interest (mandatory from 01.01.2023)
    aitDividendRate:             0.15,  // Period 2 WHT on dividends (final WHT from 01.01.2023)
    apitMonthlyThreshold:     100_000,  // Period 2: Rs.100,000/month (= Rs.300,000 / 3 months)
    // ── Period 1 values (old IRA 2017 regime)
    personalReliefP1:       2_250_000,  // Period 1 actual (9-month period)
    expenditureReliefP1:      900_000,  // Period 1 expenditure relief (9-month period)
    totalReliefP1:          3_150_000,  // P1 personal + expenditure (for the 9-month period)
    aitRateP1:                   0.06,  // Period 1 AIT on interest was 6%
    aitDividendRateP1:           0.12,  // Period 1 WHT on dividends was 12%
    apitMonthlyThresholdP1:   250_000,  // Period 1: Rs.250,000/month
    act: "IRA No.24/2017 + Amendment No.45/2022 (effective 01.01.2023) | PN/IT/2022-03",
    splitYear: true,
    splitDate: "01 January 2023",
    // ── Period 2 tax slabs (on taxable income for the 3-month period)
    // Annualized equivalents: 6 bands × Rs.500,000 (matching 2023/24 structure)
    slabs: [
    ...
    // ── Period 1 tax slabs (on taxable income for the 9-month period)
    // IRD: First Rs.2,250,000 @ 6% | Next Rs.2,250,000 @ 12% | Balance @ 18%
    slabsOld: [
      { min:0,         max:2_250_000, rate:0.06, label:"First Rs.2,250,000 @ 6%"     },
      { min:2_250_000, max:4_500_000, rate:0.12, label:"Next Rs.2,250,000 @ 12%"     },
      { min:4_500_000, max:Infinity,  rate:0.18, label:"Balance above Rs.4.5M @ 18%" },
    ],
    notes: [
      "⚠️ SPLIT YEAR — Two distinct tax regimes apply for Y/A 2022/2023",
      "✅ TOTAL PERSONAL RELIEF for Y/A 2022/2023: Rs.2,550,000 (Period 1: Rs.2,250,000 + Period 2: Rs.300,000)",
      "   Source: IRD Return Guide 2022/2023 — ird.gov.lk (confirmed in official AITR filing instructions)",
      "── PERIOD 1 (01.04.2022 – 31.12.2022) — Old IRA No.24/2017 Rates ──",
      "Personal Relief: Rs.2,250,000 (for 9-month period) | Expenditure Relief: Rs.900,000 (for 9-month period)",
      "Total deductible (Period 1): Rs.3,150,000 | APIT monthly threshold: Rs.250,000/month",
      "Tax bands — Period 1: First Rs.2,250,000 @ 6% | Next Rs.2,250,000 @ 12% | Balance @ 18%",
      "AIT on FD interest: 6% (Period 1) | WHT on dividends: 12% (Period 1)",
      "── PERIOD 2 (01.01.2023 – 31.03.2023) — Amendment No.45/2022 Rates ──",
      "Personal Relief (Period 2): Rs.300,000 (Jan–Mar 2023) + Period 1: Rs.2,250,000 (Apr–Dec 2022) = Rs.2,550,000 TOTAL for Y/A 2022/2023",
      "APIT deduction mandatory regardless of employee consent (from 01.01.2023)",
      "Tax bands — Period 2: Rs.125,000 per band × 5 bands, then 36% (6%/12%/18%/24%/30%/36%)",
      "AIT on FD interest: 5% (mandatory from 01.01.2023) | WHT on dividends: 15% (final WHT)",
      "Dividends declared by resident companies on/after 01.01.2023: Final withholding payment",
      "Capital gains on disposal of investment assets: 10% CGT",
      "✅ IT/service exports & foreign income: EXEMPT for Y/A 2022/2023 (s.9(1)(q) IRA) — exemption removed from 01.04.2023 onward",
      "Source: PN/IT/2022-03 (15.12.2022) | PN/APIT/2022-01 (20.12.2022) | Amendment Act No.45/2022",
    ],
  },

  // ══════════════════════════════════════════════════════════════════════════════
  // ── 2023/2024 ── Amendment Act No.45/2022 FULLY IN EFFECT (01.04.2023 – 31.03.2024)
  // ══════════════════════════════════════════════════════════════════════════════
  // Personal Relief: Rs.1,200,000/year (= Rs.100,000/month)
  // Expenditure Relief: Not available
  // APIT employer threshold: Rs.100,000/month (mandatory deduction)
  // Tax bands on taxable income: 6 bands × Rs.500,000 (6%, 12%, 18%, 24%, 30%, 36%)
  // AIT on interest: 5% | WHT on dividends: 15% (final withholding)
  // Cash transactions ≥ Rs.500,000: must be via bank/card (Amendment No.04/2023)
  // APIT Table 01 monthly thresholds:
  //   ≤ Rs.100,000:           Nil
  //   Rs.100,001–141,667:     6% × salary – Rs.6,000
  //   Rs.141,668–183,333:    12% × salary – Rs.14,500
  //   Rs.183,334–225,000:    18% × salary – Rs.25,500
  //   Rs.225,001–266,667:    24% × salary – Rs.39,000
  //   Rs.266,668–308,333:    30% × salary – Rs.55,500
  //   Above Rs.308,333:      36% × salary – Rs.74,000
  // Source: APIT Table 02 2023/24 examples from ird.gov.lk (formula constants verified)
  // ══════════════════════════════════════════════════════════════════════════════
  "2023/2024": {
    personalRelief:         1_200_000,
    qpCap:                  1_200_000,
    maxRefund:                180_000,
    filingThreshold:          1_200_000,  // Mandatory AITR if assessable income > Rs.1,200,000
    exportRate:                  0.00,   // ✅ EXEMPT — service exports & foreign income exempt for Y/A 2023/2024
    exportExempt:                true,   // Exemption ONLY removed by Act No.02/2025 effective 01.04.2025
    aitRate:                     0.05,   // AIT on FD interest: 5% (mandatory from 01.01.2023)
    aitDividendRate:             0.15,   // WHT on dividends: 15% (final withholding)
    apitMonthlyThreshold:     100_000,   // Rs.100,000/month (= Rs.1,200,000 ÷ 12)
    act: "IRA No.24/2017 + Amendment No.45/2022 + Amendment No.04/2023",
    // APIT Table 01 monthly formula constants (verified from IRD APIT Table 02 examples)
    apitTable01: [
      { maxMonthly:100_000,  rate:0.00,  constant:       0, label:"Up to Rs.100,000 — Nil"                    },
      { maxMonthly:141_667,  rate:0.06,  constant:   6_000, label:"Rs.100,001–141,667: 6% × salary – Rs.6,000" },
      { maxMonthly:183_333,  rate:0.12,  constant:  14_500, label:"Rs.141,668–183,333: 12% × salary – Rs.14,500"},
      { maxMonthly:225_000,  rate:0.18,  constant:  25_500, label:"Rs.183,334–225,000: 18% × salary – Rs.25,500"},
      { maxMonthly:266_667,  rate:0.24,  constant:  39_000, label:"Rs.225,001–266,667: 24% × salary – Rs.39,000"},
      { maxMonthly:308_333,  rate:0.30,  constant:  55_500, label:"Rs.266,668–308,333: 30% × salary – Rs.55,500"},
      { maxMonthly:Infinity, rate:0.36,  constant:  74_000, label:"Above Rs.308,333: 36% × salary – Rs.74,000"  },
    ],
    slabs: [
      { min:0,         max:  500_000, rate:0.06, label:"First Rs.500,000 @ 6%"       },
      { min:  500_000, max:1_000_000, rate:0.12, label:"Next Rs.500,000 @ 12%"       },
    ...
    notes: [
      "Personal Relief: Rs.1,200,000/year (= Rs.100,000/month) — Amendment No.45/2022 fully in effect",
      "Expenditure Relief: Not available for Y/A 2023/2024",
      "Mandatory AITR filing if assessable income > Rs.1,200,000",
      "APIT: Employer deduction mandatory (Table 01 threshold Rs.100,000/month)",
      "APIT Table 01: ≤Rs.100k Nil | Rs.100k–141.7k: 6%–Rs.6k | Rs.141.7k–183.3k: 12%–Rs.14.5k",
      "APIT Table 01: Rs.183.3k–225k: 18%–Rs.25.5k | Rs.225k–266.7k: 24%–Rs.39k | Rs.266.7k–308.3k: 30%–Rs.55.5k | >Rs.308.3k: 36%–Rs.74k",
      "AIT on FD interest: 5% (creditable against final IIT liability)",
      "WHT on dividends: 15% — Final withholding payment for resident companies",
      "Capital gains on investment asset disposals: 10% (CGT)",
      "Listed company share gains: EXEMPT from CGT",
      "Cash transactions ≥ Rs.500,000 must be via account payee cheque / bank draft / card (Amendment No.04/2023)",
      "✅ Service exports & foreign income: EXEMPT from income tax for Y/A 2023/2024 (under s.9(1)(q) IRA) — exemption removed only by Act No.02/2025 from 01.04.2025",
      "Qualifying payments (QP) deduction: maximum Rs.1,200,000",
      "Source: IRA No.24/2017 + Amdt No.45/2022 + Amdt No.04/2023 | IRD APIT Tables 2023-2024 | ird.gov.lk",
    ],
  },

  // ══════════════════════════════════════════════════════════════════════════════
  // ── 2024/2025 ── (01.04.2024 – 31.03.2025)
  // ══════════════════════════════════════════════════════════════════════════════
  // Personal Relief: Rs.1,200,000/year (= Rs.100,000/month) — UNCHANGED from 2023/24
  // Tax band structure: UNCHANGED — 6 bands × Rs.500,000 (6% to 36%)
  // AIT on interest: UNCHANGED at 5%
  // WHT on dividends: 15% (final withholding)
  // APIT monthly threshold: Rs.100,000/month (UNCHANGED)
  // NEW: IRD Compliance Ruling 2024/01 — Transfer pricing documentation mandatory
  // NEW: Refund claims must be made within 30 months of last day of Y/A (from 2024/25)
  // APIT Table 01 monthly thresholds: SAME as 2023/2024
  // Source: SET Guide 2024/2025 | IRD SET_24_25_Guide_E.pdf
  // ══════════════════════════════════════════════════════════════════════════════
  "2024/2025": {
    personalRelief:         1_200_000,
    qpCap:                  1_200_000,
    maxRefund:                180_000,
    filingThreshold:          1_200_000,
    exportRate:                  0.00,  // ✅ EXEMPT — service exports & foreign income still exempt for Y/A 2024/2025
    exportExempt:                true,  // Exemption ONLY removed by Act No.02/2025 effective 01.04.2025
    aitRate:                     0.05,  // AIT on interest: 5% (UNCHANGED from 2023/24)
    aitDividendRate:             0.15,  // WHT on dividends: 15% (final withholding)
    apitMonthlyThreshold:     100_000,  // UNCHANGED: Rs.100,000/month
    act: "IRA No.24/2017 + Amendment No.45/2022 + Amendment No.04/2023 (Y/A 2024/2025)",
    // APIT Table 01 — SAME structure as 2023/2024 (unchanged)
    apitTable01: [
      { maxMonthly:100_000,  rate:0.00,  constant:      0, label:"Up to Rs.100,000 — Nil"                    },
      { maxMonthly:141_667,  rate:0.06,  constant:  6_000, label:"Rs.100,001–141,667: 6% × salary – Rs.6,000" },
      { maxMonthly:183_333,  rate:0.12,  constant: 14_500, label:"Rs.141,668–183,333: 12% × salary – Rs.14,500"},
    ...
    notes: [
      "Personal Relief: Rs.1,200,000/year — UNCHANGED from 2023/24 (= Rs.100,000/month)",
      "Tax band structure: UNCHANGED — 6 bands × Rs.500,000 @ 6%, 12%, 18%, 24%, 30%, 36%",
      "Mandatory AITR filing if assessable income > Rs.1,200,000",
      "APIT employer deduction: Mandatory | Threshold: Rs.100,000/month (UNCHANGED)",
      "APIT Table 01: SAME as 2023/24 (≤Rs.100k Nil, then 6%–36% with formula constants)",
      "AIT on FD interest: 5% (UNCHANGED) — creditable against final IIT",
      "WHT on dividends: 15% — Final withholding (UNCHANGED)",
      "🆕 Refund claims: Must be applied within 30 months of last day of Y/A (from 2024/25)",
      "🆕 IRD Compliance Ruling 2024/01: Transfer pricing documentation now MANDATORY",
      "Capital gains on investment asset disposals: 10% (CGT)",
      "✅ Service exports & foreign income: EXEMPT from income tax for Y/A 2024/2025 (s.9(1)(q) IRA) — exemption removed only by Act No.02/2025 from 01.04.2025",
      "Qualifying payments (QP) deduction: maximum Rs.1,200,000",
      "Source: IRA No.24/2017 + Amdt No.45/2022 | IRD SET Guide 2024/25 | ird.gov.lk",
    ],
  },

  // ══════════════════════════════════════════════════════════════════════════════
  // ── 2025/2026 ── Inland Revenue (Amendment) Act No.02 of 2025
  // ══════════════════════════════════════════════════════════════════════════════
  // Act No.02 of 2025 certified on 20.03.2025 | Effective 01.04.2025
  // Source: IRD Notice PN/IT/2025-01 (26.03.2025) | APIT Table 01 2025/26 — ird.gov.lk
  //
  // KEY CHANGES from 2024/2025:
  //   ✅ Personal Relief INCREASED: Rs.1,800,000 (from Rs.1,200,000)
  //   ✅ First slab WIDENED: 6% on first Rs.1,000,000 (was Rs.500,000)
  //   ❌ 12% band ELIMINATED — rates jump directly 6% → 18%
  //   ⬆️ AIT on interest INCREASED: 10% (was 5%)
  //   ❌ Export/foreign income tax EXEMPTION REMOVED — now taxed at 15% flat
  //   ⬆️ Betting/gaming/tobacco/liquor: 45% flat (increased from 40%)
  //
  // APIT Table 01 (2025/2026) — Verified from ird.gov.lk:
  //   Monthly regular profits from employment:
  //   ≤ Rs.150,000:                   Nil (relief already deducted in table)
  //   Rs.150,001 – Rs.233,333:        6% × salary – Rs.9,000
  //   Rs.233,334 – Rs.275,000:       18% × salary – Rs.37,000
  //   Rs.275,001 – Rs.316,667:       24% × salary – Rs.53,500
  //   Rs.316,668 – Rs.358,333:       30% × salary – Rs.72,500
  //   Above Rs.358,333:              36% × salary – Rs.94,000
  // ══════════════════════════════════════════════════════════════════════════════
  "2025/2026": {
    personalRelief:         1_800_000,  // ✅ Increased from Rs.1,200,000 (Act No.02/2025)
    qpCap:                  1_200_000,
    maxRefund:                180_000,  // Refunds up to Rs.180,000 processed within 3 months
    filingThreshold:          1_800_000, // Mandatory AITR if assessable income > Rs.1,800,000
    exportRate:                  0.15,  // 15% flat — exemption REMOVED by Act No.02/2025
    aitRate:                     0.10,  // ⬆️ AIT on interest INCREASED to 10% (was 5%)
    aitDividendRate:             0.15,  // WHT on dividends: 15% (unchanged)
    apitMonthlyThreshold:     150_000,  // Rs.150,000/month (= Rs.1,800,000 ÷ 12)
    act: "Inland Revenue (Amendment) Act No.02 of 2025 — certified 20.03.2025",
    // APIT Table 01 (2025/2026) — Verified from official IRD APIT tables
    apitTable01: [
      { maxMonthly:150_000,  rate:0.00,  constant:      0, label:"Up to Rs.150,000 — Nil (relief included in table)" },
      { maxMonthly:233_333,  rate:0.06,  constant:  9_000, label:"Rs.150,001–233,333: 6% × salary – Rs.9,000"       },
      { maxMonthly:275_000,  rate:0.18,  constant: 37_000, label:"Rs.233,334–275,000: 18% × salary – Rs.37,000"     },
      { maxMonthly:316_667,  rate:0.24,  constant: 53_500, label:"Rs.275,001–316,667: 24% × salary – Rs.53,500"     },
      { maxMonthly:358_333,  rate:0.30,  constant: 72_500, label:"Rs.316,668–358,333: 30% × salary – Rs.72,500"     },
      { maxMonthly:Infinity, rate:0.36,  constant: 94_000, label:"Above Rs.358,333: 36% × salary – Rs.94,000"       },
    ],
    slabs: [
      // 12% band ELIMINATED — gap from 6% directly to 18%
    ...
    notes: [
      "✅ Personal Relief INCREASED: Rs.1,800,000/year (= Rs.150,000/month) — was Rs.1,200,000",
      "✅ First slab WIDENED: 6% applies to first Rs.1,000,000 taxable income (was Rs.500,000)",
      "❌ 12% band ELIMINATED — progressive rates now: 6%, 18%, 24%, 30%, 36%",
      "⬆️ AIT on FD interest INCREASED to 10% (was 5%) — effective 01.04.2025",
      "❌ Export/foreign income exemption REMOVED — now taxed at 15% flat rate (Act No.02/2025)",
      "APIT Table 01 threshold: Rs.150,000/month (verified from IRD APIT Tables 2025/26)",
      "APIT Table 01: ≤Rs.150k Nil | Rs.150k–233.3k: 6%–Rs.9k | Rs.233.3k–275k: 18%–Rs.37k",
      "APIT Table 01: Rs.275k–316.7k: 24%–Rs.53.5k | Rs.316.7k–358.3k: 30%–Rs.72.5k | >Rs.358.3k: 36%–Rs.94k",
      "Mandatory AITR filing if assessable income > Rs.1,800,000",
      "Refunds up to Rs.180,000: processed within 3 months before audit (from Y/A 2025/26)",
      "Senior citizens: Quarterly refund up to Rs.45,000 without audit",
      "Betting/gaming/tobacco/liquor: 45% flat rate (individual and company)",
      "WHT on dividends: 15% (final withholding — unchanged)",
      "Service exports & foreign source income: 15% flat (max rate, not exempt)",
      "Source: PN/IT/2025-01 (26.03.2025) | Act No.02 of 2025 | APIT Table 01 2025/26 | ird.gov.lk",
    ],
  },

  // ── 2026/2027 ── Provisional (Budget 2026 not yet enacted as of Feb 2026)
  // Rates based on Act No.02/2025 structure. Verify at ird.gov.lk before filing.
  "2026/2027": {
    ...
    exportRate:                  0.15,
    aitRate:                     0.10,
    aitDividendRate:             0.15,
    apitMonthlyThreshold:     150_000,
    act: "Provisional — Budget 2026 pending (based on Act No.02/2025 structure)",
    apitTable01: [
      { maxMonthly:150_000,  rate:0.00,  constant:      0, label:"Up to Rs.150,000 — Nil"            },
      { maxMonthly:233_333,  rate:0.06,  constant:  9_000, label:"Rs.150,001–233,333: 6%–Rs.9,000"  },
      { maxMonthly:275_000,  rate:0.18,  constant: 37_000, label:"Rs.233,334–275,000: 18%–Rs.37,000"},
      { maxMonthly:316_667,  rate:0.24,  constant: 53_500, label:"Rs.275,001–316,667: 24%–Rs.53,500"},
      { maxMonthly:358_333,  rate:0.30,  constant: 72_500, label:"Rs.316,668–358,333: 30%–Rs.72,500"},
      { maxMonthly:Infinity, rate:0.36,  constant: 94_000, label:"Above Rs.358,333: 36%–Rs.94,000"  },
    ],
    slabs: [
      { min:0,         max:1_000_000, rate:0.06, label:"First Rs.1,000,000 @ 6%"     },
      { min:1_000_000, max:1_500_000, rate:0.18, label:"Next Rs.500,000 @ 18%"       },
    ...
    notes: [
      "⚠️ PROVISIONAL — Budget 2026 not yet enacted. Rates based on Act No.02/2025.",
      "Personal Relief: Rs.1,800,000 | APIT threshold: Rs.150,000/month",
      "Please verify all rates at www.ird.gov.lk before filing your 2026/2027 tax return",
    ],
  },
};
...
// Income categories per IRD Act No.24/2017 and Amendment Act No.02/2025
// Grouped by IRD assessable income type with WHT/AIT annotations
// ── INCOME CATEGORIES per IRA No.24/2017 (as amended) ──────────────────────────
// SALARIED — Sections 2–5 & 7–10 IRA (Employment + Investment + Other)
const INCOME_CATS_SALARIED = [
  // ── EMPLOYMENT INCOME (IRA Section 2) ──────────────────────────
  "Salary / Wages",              // Regular salary/wages — APIT by employer
  "Director's Fees",             // Section 2 / WHT 5% at source
  "Bonus / Incentive",           // Part of employment income — APIT applies
  "Overtime Pay",                // Included in employment income — APIT applies
  "Non-Cash Benefits",           // Vehicle/housing/meals — imputed value taxable
  "Gratuity / Terminal Benefits",// Special tax: 0% on first Rs.10M, 6% next Rs.10M, 12% balance
  "Pension from Employment",     // Regular pension from employer / ETF — taxable as employment
  "ESOP / Share Scheme Gains",   // Employer share option/scheme — taxable at market value
  // ── INVESTMENT INCOME (IRA Section 4) ──────────────────────────
  "Rental Income",               // AIT 10% if tenant is institution/company; s.18 IRA
  "Dividends",                   // AIT 15% deducted at source; s.21 IRA
  "Interest / FD Income",        // AIT 10% (from 01.04.2025, was 5%); s.20 IRA
  "Royalties",                   // WHT 10% at source; s.22 IRA
  "Annuity / Private Pension",   // Annuity from insurance / approved scheme; s.24 IRA
  "Partnership Share of Profit", // Share of net profit from partnership; s.26 IRA
  // ── SPECIAL RATE INCOME ────────────────────────────────────────
  "Capital Gains",               // 10% CGT — disposal of investment assets; s.40 IRA
  "Export Services (15%)",       // 15% flat from 01.04.2025 (Y/A 2025/26+) | EXEMPT prior years
  "Foreign Remittance (15%)",    // 15% flat — foreign-sourced income remitted via bank; s.59 IRA
  // ── OTHER INCOME (IRA Section 6) ───────────────────────────────
  "Lottery / Prize Winnings",    // No WHT — assessable at graduated IIT rate
  "Casual / Irregular Income",   // One-off receipts not classified above
  "Other Income",                // Miscellaneous assessable income
];
// FREELANCER / SELF-EMPLOYED — Sections 3–5 IRA (Business + Investment + Other)
const INCOME_CATS_FREELANCER = [
  // ── BUSINESS / PROFESSIONAL INCOME (IRA Section 3) ─────────────
  "Freelance / Contract Fees",   // Professional services — WHT 5% if institution payer
  "Business / Trade Income",     // Sole trader gross revenue; s.11 IRA
  "Professional Practice Income",// Doctor, lawyer, accountant, architect, engineer fees
  "Commission Income",           // WHT 5% at source; s.83 IRA
  "Consulting Fees",             // WHT 5% if single-payer > Rs.150,000/month
  "Agriculture Income",          // Small farmers may be exempt; large-scale taxable
  "Partnership Share of Profit", // Partner's share of net profit; s.26 IRA
  // ── INVESTMENT INCOME (IRA Section 4) ──────────────────────────
  "Rental Income",               // AIT 10% if tenant is institution; s.18 IRA
  "Dividends",                   // AIT 15% deducted at source; s.21 IRA
  "Interest / FD Income",        // AIT 10% (from 01.04.2025, was 5%); s.20 IRA
  "Royalties",                   // WHT 10% at source; s.22 IRA
  "Annuity / Private Pension",   // Annuity income from investment; s.24 IRA
  // ── SPECIAL RATE INCOME ────────────────────────────────────────
  "Capital Gains",               // 10% CGT — disposal of investment assets; s.40 IRA
  "Export Services (15%)",       // 15% flat from 01.04.2025 (Y/A 2025/26+) | EXEMPT prior years
  "Foreign Remittance (15%)",    // 15% flat — foreign-sourced income remitted via bank; s.59 IRA
  // ── OTHER INCOME (IRA Section 6) ───────────────────────────────
  "Lottery / Prize Winnings",    // No WHT — assessable at graduated IIT rate
  "Casual / Irregular Income",   // One-off receipts
  "Other Income",                // Miscellaneous assessable income
];

// ── WHT/AIT metadata per income category ─────────────────────────────────────
// Source: IRA No.24/2017 + Amendment Act No.45/2022 + Amendment Act No.02/2025
// section = IRA section reference | flat = flat-rate (not progressive IIT)
const INCOME_CAT_META = {
  // ── Employment Income (IRA Section 2) ──
  "Salary / Wages":               { wht: null,   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "APIT deducted by employer monthly. Enter gross amount including allowances." },
  "Director's Fees":              { wht: "5%",   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "WHT 5% deducted at source by company. Net amount received + WHT = gross." },
  "Bonus / Incentive":            { wht: null,   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "Included in employment income — employer deducts APIT. Enter gross bonus." },
  "Overtime Pay":                 { wht: null,   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "Overtime is part of employment income — APIT deducted by employer." },
  "Non-Cash Benefits":            { wht: null,   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "Imputed value of vehicle use, housing, meals etc. — included in assessable employment income." },
  "Gratuity / Terminal Benefits": { wht: null,   flat: true,  section:"s.7 IRA",  irdCat:"Employment", note: "SPECIAL TAX RATES: First Rs.10,000,000 @ 0% · Next Rs.10,000,000 @ 6% · Balance @ 12%. Not subject to regular graduated IIT." },
  "Pension from Employment":      { wht: null,   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "Regular pension / ETF receipts from employer — assessable employment income. Enter annual amount." },
  "ESOP / Share Scheme Gains":    { wht: null,   flat: false, section:"s.2 IRA",  irdCat:"Employment", note: "Value of employer shares/options received — assessable at market value on grant date." },
  // ── Business / Professional Income (IRA Section 3) ──
  "Freelance / Contract Fees":    { wht: "5%",   flat: false, section:"s.11 IRA", irdCat:"Business",   note: "WHT 5% if payer is institution and payment > Rs.150,000/month per s.83 IRA." },
  "Business / Trade Income":      { wht: null,   flat: false, section:"s.11 IRA", irdCat:"Business",   note: "Gross business revenue. Allowable expenses are deductible. Enter gross income here; deductions in Ledger." },
  "Professional Practice Income": { wht: "5%",   flat: false, section:"s.11 IRA", irdCat:"Business",   note: "Doctor, lawyer, accountant, engineer, architect fees. WHT 5% if payer is institution." },
  "Commission Income":            { wht: "5%",   flat: false, section:"s.83 IRA", irdCat:"Business",   note: "WHT 5% deducted at source by paying institution." },
  "Consulting Fees":              { wht: "5%",   flat: false, section:"s.83 IRA", irdCat:"Business",   note: "WHT 5% if single-payer payment > Rs.150,000/month from any one institution." },
  "Agriculture Income":           { wht: null,   flat: false, section:"s.11 IRA", irdCat:"Business",   note: "Small farmers may be exempt. Large-scale commercial agriculture is assessable business income." },
  "Partnership Share of Profit":  { wht: null,   flat: false, section:"s.26 IRA", irdCat:"Business",   note: "Individual partner's share of taxable net profit — assessed at partner level at progressive IIT rates." },
  // ── Investment Income (IRA Section 4) ──
  "Rental Income":                { wht: "10%",  flat: false, section:"s.18 IRA", irdCat:"Investment", note: "AIT 10% if tenant is a company or institution. 25% rental relief deductible OR actual maintenance/depreciation." },
  "Dividends":                    { wht: "15%",  flat: false, section:"s.21 IRA", irdCat:"Investment", note: "AIT 15% deducted at source. Gross dividend (incl. AIT) is assessable. AIT is creditable against IIT." },
  "Interest / FD Income":         { wht: "10%",  flat: false, section:"s.20 IRA", irdCat:"Investment", note: "AIT 10% from 01.04.2025 (was 5% in Y/A 2022–2025). Enter gross interest before AIT deduction." },
  "Royalties":                    { wht: "10%",  flat: false, section:"s.22 IRA", irdCat:"Investment", note: "WHT 10% deducted at source. Gross amount (incl. WHT) is assessable income." },
  "Annuity / Private Pension":    { wht: null,   flat: false, section:"s.24 IRA", irdCat:"Investment", note: "Annuity from insurance policy or approved pension scheme — assessable investment income." },
  // ── Special Rate Income ──
  "Capital Gains":                { wht: "10%",  flat: true,  section:"s.40 IRA", irdCat:"CapGain",    note: "CGT 10% on disposal of investment assets (unlisted shares, land, buildings). Listed share gains: EXEMPT." },
  "Export Services (15%)":        { wht: "15%",  flat: true,  section:"s.59 IRA", irdCat:"Export",     note: "15% flat tax — services rendered outside Sri Lanka, payment in foreign currency remitted to SL bank. Exemption REMOVED from 01.04.2025 per Act No.2/2025." },
  "Foreign Remittance (15%)":     { wht: "15%",  flat: true,  section:"s.59 IRA", irdCat:"Export",     note: "15% flat — foreign-sourced income (non-service) earned in foreign currency remitted to Sri Lanka via bank." },
  // ── Other Income (IRA Section 6) ──
  "Lottery / Prize Winnings":     { wht: null,   flat: false, section:"s.6 IRA",  irdCat:"Other",      note: "No automatic WHT on lottery/prize winnings — assessable as other income at graduated IIT rates." },
  "Casual / Irregular Income":    { wht: null,   flat: false, section:"s.6 IRA",  irdCat:"Other",      note: "One-off receipts not falling under employment/business/investment. Assessable at progressive rates." },
  "Other Income":                 { wht: null,   flat: false, section:"s.6 IRA",  irdCat:"Other",      note: "Include in assessable income at applicable graduated IIT rate. Document source and basis." },
};

const TXN_CATS_INCOME  = ["Salary/Employment","Director's Fees","Freelance Receipt","Business Receipt","Professional Fees","Commission","Consulting Fees","Rental Receipt","Dividend","FD Interest","Royalty","Capital Gain","Export Receipt","Foreign Remittance","Bonus","Overtime","Gratuity","Pension","ESOP/Shares","Partnership Income","Annuity","Lottery/Prize","Agriculture Income","Refund","Other Receipt"];
...
// ─── Google Play Billing (Digital Goods API — TWA) ────────────────────────────
// IMPORTANT: Replace this placeholder SKU with the exact Product ID you create
// in Google Play Console → Monetization → Subscriptions.
const PLAY_BILLING_SKU = "taxcalclk_annual_v1"; // ← PLACEHOLDER — update before release
...
async function getPlaySkuDetails(){
  try{
    const svc=await window.getDigitalGoodsService("https://play.google.com/billing");
    const details=await svc.getDetails([PLAY_BILLING_SKU]);
    return details&&details.length>0?details[0]:null;
  }catch(e){console.warn("Play SKU details error:",e);return null;}
}

async function checkExistingPlayPurchase(){
  // Called on app load — verifies if user already has an active Play subscription
  try{
    const svc=await window.getDigitalGoodsService("https://play.google.com/billing");
    const purchases=await svc.listPurchases();
    return purchases.find(p=>p.itemId===PLAY_BILLING_SKU)||null;
  }catch(e){console.warn("Play purchase check error:",e);return null;}
}

async function launchPlaySubscription(){
  // Returns {ok:true, token} on success or {ok:false, reason} on failure
  try{
    const request=new PaymentRequest(
      [{supportedMethods:"https://play.google.com/billing",data:{sku:PLAY_BILLING_SKU}}],
      {total:{label:"TaxCalc LK Annual Subscription",amount:{currency:"LKR",value:"0"}}}
    );
    const canPay=await request.canMakePayment();
    if(!canPay) return {ok:false,reason:"Google Play Billing is not available on this device."};
    const response=await request.show();
    const token=response?.details?.purchaseToken||response?.details?.token||"play_purchase";
    await response.complete("success");
    return {ok:true,token};
  }catch(e){
    if(e.name==="AbortError") return {ok:false,reason:"cancelled"};
    console.warn("Play billing error:",e);
    return {ok:false,reason:"Purchase failed. Please try again or contact support."};
  }
}
...
// ── PWA: inject manifest + register service worker ───────────────────────────
  useEffect(()=>{
    ...
    const blobUrl="data:application/manifest+json;charset=utf-8,"+encodeURIComponent(manifestStr);
    ...
    // Set page title
    document.title="TaxCalc LK — Finance & Tax Manager";
    ...
    return()=>{}; // no cleanup needed for data URI
  },[]);
  // ─────────────────────────────────────────────────────────────────────────────
  ...
  useEffect(()=>{
    (async()=>{
      ...
      // Load admin-set pricing from shared storage
      const pricing = await load(ADMIN_PRICING_KEY, true);
      if(pricing?.annualPrice) SUBSCRIPTION_PRICE = pricing.annualPrice;
    })();
  },[]);
  ...
  const activatePaid=useCallback(async(source="payhere",codeUsed=null)=>{
    ...
    const s={startDate:today(),plan:"paid",expiryDate:expiry,paidAt:new Date().toISOString(),activatedVia:source};
    setSub(s); await save("fintax_sub_v4",s);
    // Record subscriber in shared admin list for management
    const subs=(await load(ADMIN_SUBSCRIBERS_KEY,true))||{};
    const subId=profile?.mobile||profile?.name||"unknown";
    subs[subId]={name:profile?.name,mobile:profile?.mobile,activatedAt:s.paidAt,expiryDate:expiry,plan:"paid",active:true,code:codeUsed||"",source};
    await save(ADMIN_SUBSCRIBERS_KEY,subs,true);
  ...
  const activateWithPlay=useCallback(async()=>{
    const result=await launchPlaySubscription();
    if(!result.ok) return result;
    await activatePaid("google_play",result.token);
    return {ok:true};
  },[activatePaid]);
  ...
  const isExpiredTrial=sub?.plan==="trial"&&daysDiff(today(),sub.startDate)>=FREE_TRIAL_DAYS;
  const isExpiredPaid=sub?.plan==="paid"&&daysDiff(today(),sub.expiryDate)>0;
  const isLocked=isExpiredTrial||isExpiredPaid;
  if(isLocked) return <Paywall onPlaySubscribe={activateWithPlay} reason={sub?.plan==="trial"?"trial":"expired"} profile={profile} lang={lang} setLang={setLang}/>;

  // Renewal reminder — show banner if paid sub expiring in ≤30 days
  const paidDaysLeft=sub?.plan==="paid"?Math.ceil((new Date(sub.expiryDate)-new Date())/(86400000)):null;
  ...
  const props={data,update,profile,setProfile:saveProfile,tax,cashBalance,totalBankBal,bankBalance,trialDaysLeft,paidDaysLeft,onUpgrade:activateWithPlay,sub,incomeCats,handleLogoTap,lang,setLang,t,activeYear,switchYear};
  ...
  return(
    <div style={S.phone}>
      ...
      `}</style>
      <StatusBar trialDaysLeft={trialDaysLeft} paidDaysLeft={paidDaysLeft} profile={profile} onEditProfile={()=>setScreen("onboard")} onLogoTap={handleLogoTap} lang={lang} setLang={setLang} activeYear={activeYear} switchYear={switchYear}/>
      <div style={S.screen}>
...
function PlansSelector({lang,profile}){
  const [tab,setTab]=React.useState("individual");
  const individualPlans=[
    {name:"Basic",price:"Rs.4,800",sub:"/yr",badge:"",color:"#475569",border:"#334155",
     features:["Tax computation (IIT 2025/26)","Cash book & bank tracking","9 financial tools","Downloadable reports","30-day free trial"],
     desc:"App only — self-service calculations"},
    {name:"Pro",price:"Rs.12,000",sub:"/yr",badge:"✨ POPULAR",color:"#b8960c",border:"#b8960c",
     features:["Everything in Basic","FREE AITR filing by GDP Consultants","1-hour tax advisor consultation","WhatsApp priority support","30-day free trial"],
     included:["FREE AITR Filing","1hr Consultation"],
     desc:"App + FREE tax return filing + 1hr consultation"},
    {name:"Premium",price:"Rs.24,000",sub:"/yr",badge:"PREMIUM",color:"#a78bfa",border:"#6d28d9",
     features:["Everything in Pro","Quarterly tax review (4/yr)","Advance tax planning","IRD correspondence handling","Dedicated advisor"],
     included:["4 Quarterly Reviews","IRD Correspondence","Advance Tax Planning"],
     desc:"App + quarterly reviews + full tax support"},
  ];
  const companyPlans=[
    {name:"Starter",price:"Rs.18,000",sub:"/yr",badge:"",color:"#06b6d4",border:"#0e7490",
     features:["Company tax computation","Multi-bank & cash tracking","VAT monitoring","Annual return filing","30-day free trial"],
     included:["Annual Return Filing"],
     desc:"Small company — app + annual filing support"},
    {name:"Business",price:"Rs.36,000",sub:"/yr",badge:"✨ POPULAR",color:"#f59e0b",border:"#92400e",
     features:["Everything in Starter","Quarterly management accounts","Payroll/APIT up to 5 employees","Audit preparation assistance","Priority WhatsApp support"],
     included:["Quarterly Mgmt Accounts","Payroll up to 5 staff","Audit Prep"],
     desc:"App + quarterly management accounts + payroll"},
    {name:"Enterprise",price:"Rs.60,000",sub:"/yr",badge:"ENTERPRISE",color:"#10b981",border:"#064e3b",
     features:["Everything in Business","Full bookkeeping","Statutory audit certificate","Transfer pricing docs","Unlimited payroll","Dedicated CA partner"],
     included:["Full Bookkeeping","Statutory Audit","Transfer Pricing","Unlimited Payroll"],
     desc:"Full outsourced accounting, audit & compliance"},
  ];
  const plans=tab==="individual"?individualPlans:companyPlans;
  return(
    <div style={{width:"100%",marginBottom:14}}>
      <div style={{textAlign:"center",fontSize:13,fontWeight:"800",color:"#f1f5f9",marginBottom:10}}>Choose Your Plan</div>
      <div style={{display:"flex",background:"#0a0d1a",border:"1px solid #1e293b",borderRadius:10,marginBottom:12,padding:3}}>
        {[{key:"individual",label:"Individual"},{key:"company",label:"Company"}].map(t=>(
          <button key={t.key} onClick={()=>setTab(t.key)}
            style={{flex:1,padding:"8px",border:"none",borderRadius:8,fontWeight:"700",fontSize:12,cursor:"pointer",
              background:tab===t.key?"linear-gradient(135deg,#1e3a5f,#1d4ed8)":"transparent",
              color:tab===t.key?"#93c5fd":"#475569"}}>
            {t.key==="individual"?"Individual":"Company"}
          </button>
        ))}
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6}}>
        {plans.map(p=>(
          <div key={p.name} style={{background:"#0a0d1a",border:"2px solid "+p.border,borderRadius:10,padding:"10px 8px",textAlign:"center",position:"relative"}}>
            {p.badge&&<div style={{position:"absolute",top:-8,left:"50%",transform:"translateX(-50%)",background:["PREMIUM","ENTERPRISE"].includes(p.badge)?"#6d28d9":"#b8960c",color:"#fff",fontSize:7,fontWeight:"800",padding:"2px 5px",borderRadius:4,whiteSpace:"nowrap"}}>{p.badge}</div>}
            <div style={{fontSize:11,fontWeight:"800",color:p.color,marginBottom:3}}>{p.name}</div>
            <div style={{fontSize:14,fontWeight:"900",color:"#f1f5f9"}}>{p.price}</div>
            <div style={{fontSize:9,color:"#64748b",marginBottom:5}}>{p.sub}</div>
            {p.features.slice(0,3).map(f=><div key={f} style={{fontSize:8,color:"#94a3b8",padding:"1px 0",textAlign:"left"}}>{"✓ "}{f}</div>)}
            {p.included&&<div style={{marginTop:4,borderTop:"1px solid #1e293b",paddingTop:3}}>{p.included.slice(0,2).map(i=><div key={i} style={{fontSize:7,color:"#34d399",fontWeight:"700",padding:"1px 0"}}>{"♥ "}{i}</div>)}</div>}
          </div>
        ))}
      </div>
      <div style={{fontSize:10,color:"#475569",textAlign:"center",marginTop:8}}>
        All plans include a 30-day free trial {"·"} WhatsApp us to get started
      </div>
    </div>
  );
}

function Paywall({onPlaySubscribe,reason,profile,lang,setLang}){
  const [loading,setLoading]=useState(false);
  const [playAvail,setPlayAvail]=useState(null); // null=checking, true, false
  const [skuLabel,setSkuLabel]=useState("Annual Subscription");
  const [msg,setMsg]=useState(null); // {type:"error"|"info", text}
  const [priceSetting,setPriceSetting]=useState(DEFAULT_SUBSCRIPTION_PRICE);

  useEffect(()=>{
    (async()=>{
      // Check Play billing availability
      const avail=await isPlayBillingAvailable();
      setPlayAvail(avail);
      if(avail){
        const sku=await getPlaySkuDetails();
        if(sku?.title) setSkuLabel(sku.title);
      }
      // Load admin pricing for display
      const p=await load(ADMIN_PRICING_KEY,true);
      if(p?.annualPrice) setPriceSetting(p.annualPrice);
    })();
  },[]);

  const handleSubscribe=async()=>{
    setLoading(true); setMsg(null);
    const result=await onPlaySubscribe();
    setLoading(false);
  ...
  return(
    <div style={{...S.phone,overflowY:"auto",padding:20,justifyContent:"flex-start",alignItems:"center",background:"linear-gradient(160deg,#060d1a,#0a0a00)"}}>
      ...
      <div style={{fontSize:20,fontWeight:"800",color:"#f1f5f9",textAlign:"center",marginBottom:4}}>
        {reason==="trial"?T(lang,"trial_ended"):T(lang,"sub_expired")}
      </div>
      <div style={{fontSize:12,color:"#64748b",textAlign:"center",marginBottom:24,lineHeight:1.6,maxWidth:300}}>
        {reason==="trial"?T(lang,"trial_msg"):T(lang,"expired_msg")}
      </div>

      {/* Plans overview */}
      <PlansSelector lang={lang} profile={profile}/>

      {/* Price card */}
      <div style={{...S.card,border:"1px solid #b8960c",width:"100%",boxSizing:"border-box",background:"linear-gradient(160deg,#0d0d00,#1a1500)",marginBottom:16,marginTop:12}}>
        <div style={{textAlign:"center",color:"#b8960c",fontSize:11,fontWeight:"800",letterSpacing:1,marginBottom:8}}>{T(lang,"annual_plan")}</div>
        <div style={{textAlign:"center",fontSize:36,fontWeight:"900",color:"#f5d060"}}>
          Rs.{priceSetting.toLocaleString()}<span style={{fontSize:13,color:"#64748b",fontWeight:"400"}}>/year</span>
        </div>
        <div style={{textAlign:"center",fontSize:11,color:"#34d399",fontWeight:"700",margin:"8px 0 14px",padding:"6px",background:"#0a2a1a",borderRadius:8}}>
          🎁 Includes FREE Tax Return Filing + Tax Advisor Consultation
        </div>
      ...
      {playAvail===false?(
        <div style={{width:"100%",background:"#0a1525",border:"1px solid #1e3a5f",borderRadius:12,padding:"16px",textAlign:"center",marginBottom:16}}>
          <div style={{fontSize:13,color:"#93c5fd",fontWeight:"700",marginBottom:6}}>📱 Open in Google Play App</div>
          <div style={{fontSize:11,color:"#64748b",lineHeight:1.7}}>
            To subscribe, please open <strong style={{color:"#e2e8f0"}}>TaxCalc LK</strong> directly from the <strong style={{color:"#34d399"}}>Google Play Store app</strong> on your Android device. Google Play billing is only available inside the Play Store version.
          </div>
        </div>
      ):(
        <button
          style={{
            width:"100%",padding:"16px",borderRadius:14,border:"none",cursor:loading||playAvail===null?"not-allowed":"pointer",
            background:loading||playAvail===null?"#374151":"linear-gradient(135deg,#1a73e8,#4285f4)",
            color:"#fff",fontSize:16,fontWeight:"800",marginBottom:10,
            display:"flex",alignItems:"center",justifyContent:"center",gap:10,
            boxShadow:loading?"none":"0 4px 16px rgba(26,115,232,0.4)"
          }}
          onClick={handleSubscribe}
          disabled={loading||playAvail===null}
        >
          {loading?(
            <><span style={{fontSize:20}}>⏳</span> {T(lang,"processing")}</>
          ):playAvail===null?(
            <><span style={{fontSize:18}}>🔄</span> Checking availability…</>
          ):(
            <><span style={{fontSize:20}}>▶</span> Subscribe via Google Play</>
          )}
        </button>
      )}

      {/* Auto-renewal notice */}
      <div style={{fontSize:10,color:"#475569",textAlign:"center",marginBottom:6,lineHeight:1.6}}>
        🔄 <strong style={{color:"#64748b"}}>Auto-renews yearly</strong> via Google Play · Cancel anytime in Play Store settings
      </div>

      {/* Error / info message */}
      {msg&&(
        <div style={{width:"100%",padding:"10px 12px",borderRadius:8,background:msg.type==="error"?"#1a0000":"#0a1525",border:"1px solid "+(msg.type==="error"?"#7f1d1d":"#1e3a5f"),color:msg.type==="error"?"#f87171":"#93c5fd",fontSize:12,fontWeight:"600",marginBottom:12,textAlign:"center"}}>
          {msg.type==="error"?"❌ ":"ℹ️ "}{msg.text}
        </div>
      )}
  ...
  return(
    <div style={{...S.phone, justifyContent:"center", alignItems:"center", background:"#060d1a"}}>
      <div style={{
        ...
        <div style={{fontSize:11, color:"#475569", marginBottom:32}}>GDP Consultants — TaxCalc LK</div>
...
function AdminPanel({onExit,lang,setLang}){
  ...
  const [view,setView]=useState("play"); // play | subs | all | reg | pay | pin | pricing
  // PIN change state
  ...
  // Pricing management
  const [priceBasic,setPriceBasic]=useState(DEFAULT_SUBSCRIPTION_PRICE);
  const [pricePro,setPricePro]=useState(12_000);
  const [priceBiz,setPriceBiz]=useState(24_000);
  ...
  const refreshData=async()=>{
    const [l,p,s]=await Promise.all([
      load("admin_notif_log",true),
      load(ADMIN_PRICING_KEY,true),load(ADMIN_SUBSCRIBERS_KEY,true)
    ]);
    setLog(l||[]); setLoading(false);
    setSubscribers(s||{});
    if(p){
      if(p.annualPrice) setPriceBasic(p.annualPrice);
      if(p.proPrice) setPricePro(p.proPrice);
      if(p.bizPrice) setPriceBiz(p.bizPrice);
    }
  };
  useEffect(()=>{refreshData();},[]);

  // Save pricing to shared storage
  const handleSavePricing=async()=>{
    const pricing={annualPrice:parseInt(priceBasic)||DEFAULT_SUBSCRIPTION_PRICE,proPrice:parseInt(pricePro)||12000,bizPrice:parseInt(priceBiz)||24000,updatedAt:new Date().toISOString()};
    await save(ADMIN_PRICING_KEY,pricing,true);
    SUBSCRIPTION_PRICE=pricing.annualPrice;
    setPriceSaved(true); setTimeout(()=>setPriceSaved(false),2500);
  };

  // Deactivate a subscriber
  const handleDeactivateSub=async(subId)=>{
    if(!window.confirm(`Deactivate subscriber ${subId}? Their app access will be revoked on next app load.`)) return;
    const subs=(await load(ADMIN_SUBSCRIBERS_KEY,true))||{};
    if(subs[subId]){ subs[subId]={...subs[subId],active:false,deactivatedAt:new Date().toISOString()}; }
    await save(ADMIN_SUBSCRIBERS_KEY,subs,true);
    await save(`fintax_deactivated_${subId}`,true,true);
    await refreshData();
  };
  ...
  const handleReactivateSub=async(subId)=>{
    const subs=(await load(ADMIN_SUBSCRIBERS_KEY,true))||{};
    if(subs[subId]){ subs[subId]={...subs[subId],active:true,deactivatedAt:null}; }
    await save(ADMIN_SUBSCRIBERS_KEY,subs,true);
    await save(`fintax_deactivated_${subId}`,false,true);
    await refreshData();
  };
    ...
    <div style={S.phone}>
      ...
      <div style={{padding:"14px",overflowY:"auto",flex:1,paddingBottom:24}}>
        ...
        <div style={S.cardRow}>
          ...
          <div style={{...S.card,flex:1,textAlign:"center",border:"1px solid #1a73e8",padding:"10px 6px"}}>
            <div style={{fontSize:14,fontWeight:"800",color:"#4fc3f7"}}>{Object.values(subscribers).filter(s=>s.active).length}</div>
            <div style={{fontSize:9,color:"#64748b"}}>Active Subs</div>
          </div>
        ...
        <div style={{display:"flex",gap:5,marginBottom:14,flexWrap:"wrap"}}>
          {[["play","▶ Play"],["subs","👥 Subs"],["pricing","💰 Pricing"],["all","📋 All"],["reg","👤 Users"],["pay","💳 Payments"],["pin","🔒 PIN"]].map(([v,l])=>(
        ...
        {view==="play"&&(
          <>
            <div style={{...S.card,border:"2px solid #1a73e8",background:"linear-gradient(160deg,#001a40,#002060)",marginBottom:14}}>
              <div style={{fontSize:13,fontWeight:"800",color:"#4fc3f7",marginBottom:10}}>▶ Google Play Subscription</div>
              <div style={{fontSize:11,color:"#90caf9",lineHeight:1.7,marginBottom:12}}>
                Subscriptions are now handled entirely via <strong style={{color:"#fff"}}>Google Play Billing</strong> with automatic yearly renewal. Users subscribe directly from the app — no manual activation required.
              </div>
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                {[
                  ["📦 SKU / Product ID", "taxcalclk_annual_v1 (placeholder — update in code & Play Console)"],
                  ["🔄 Billing cycle", "Annual — auto-renews every 12 months"],
                  ["💳 Payment method", "Google Play billing (card, UPI, Play balance)"],
                  ["❌ Cancellation", "User cancels in Play Store → access until period end"],
                  ["🔁 Refunds", "Managed by Google Play refund policy"],
                ].map(([k,v])=>(
                  <div key={k} style={{padding:"8px 10px",background:"#001030",borderRadius:8,border:"1px solid #1e3a5f"}}>
                    <div style={{fontSize:11,fontWeight:"700",color:"#4fc3f7",marginBottom:2}}>{k}</div>
                    <div style={{fontSize:11,color:"#94a3b8"}}>{v}</div>
                  </div>
                ))}
              </div>
            </div>
            <div style={{...S.card,border:"1px solid #f59e0b",background:"#1a0f00",marginBottom:14}}>
              <div style={{fontSize:12,fontWeight:"800",color:"#fbbf24",marginBottom:8}}>📋 Setup Checklist — Before Publishing</div>
              {[
                "1. Go to Play Console → TaxCalc LK → Monetize → Subscriptions",
                "2. Create subscription with ID: taxcalclk_annual_v1",
                "3. Set price (e.g. LKR 4,800/year), grace period, free trial",
                "4. Update PLAY_BILLING_SKU constant in App.jsx to match exact ID",
                "5. Add your SHA-256 fingerprint to assetlinks.json (for TWA)",
                "6. Test with a licence tester account before going live",
              ].map(s=>(
                <div key={s} style={{fontSize:10,color:"#d97706",padding:"3px 0",lineHeight:1.5}}>{s}</div>
              ))}
            </div>
          </>
        )}
          ...
          displayed.length===0?<Empty icon="📭" text="No entries yet"/>:displayed.map(n=>(
            <div key={n.id} style={{...S.card,border:"1px solid "+(n.type==="PAYMENT_RECEIVED"?"#f59e0b":"#10b981"),marginBottom:8}}>
              ...
              {n.type==="PAYMENT_RECEIVED"&&(
                <>
                  <div style={{fontSize:12,color:"#e2e8f0"}}><b>{n.data?.name}</b> · {n.data?.mobile}</div>
                  <div style={{fontSize:13,color:"#fbbf24",fontWeight:"700"}}>{fmt(n.data?.amount||0)} · via {n.data?.activatedVia||"Google Play"}</div>
        ...
        {view==="pricing"&&(
          <div>
            <div style={{...S.card,border:"2px solid #f59e0b",background:"linear-gradient(160deg,#0a0800,#1a1200)",marginBottom:14}}>
              <div style={{fontSize:13,fontWeight:"800",color:"#fbbf24",marginBottom:4}}>💰 Subscription Pricing Management</div>
              <div style={{fontSize:11,color:"#92400e",marginBottom:14,lineHeight:1.6}}>
                Set pricing here. Changes apply to all new subscribers immediately. Existing subscribers are unaffected until renewal.
              </div>
              {[
                ["Basic / Standard (Annual)", priceBasic, setPriceBasic, "annualPrice"],
                ["Pro Plan (Annual)", pricePro, setPricePro, "proPrice"],
                ["Business / Premium (Annual)", priceBiz, setPriceBiz, "bizPrice"],
              ].map(([label,val,setter])=>(
                <div key={label} style={{marginBottom:12}}>
                  <label style={{...S.lbl,color:"#fbbf24"}}>{label}</label>
                  <div style={{display:"flex",alignItems:"center",gap:8}}>
                    <span style={{color:"#f5d060",fontWeight:"700",fontSize:13}}>Rs.</span>
                    <input type="number" value={val} onChange={e=>setter(e.target.value)}
                      style={{...S.inp,background:"#0a0800",borderColor:"#92400e",color:"#f5d060",fontWeight:"700",fontSize:15,flex:1,marginBottom:0}}/>
                  </div>
                </div>
              ))}
              <button onClick={handleSavePricing}
                style={{width:"100%",padding:"12px",background:priceSaved?"#065f46":"linear-gradient(135deg,#d97706,#f59e0b)",border:"none",borderRadius:10,color:priceSaved?"#6ee7b7":"#111",fontWeight:"800",fontSize:14,cursor:"pointer",marginTop:6}}>
                {priceSaved?"✅ Pricing Saved!":"💾 Save Pricing"}
              </button>
              <div style={{fontSize:10,color:"#475569",marginTop:8,textAlign:"center"}}>
                Current active price: Rs.{SUBSCRIPTION_PRICE.toLocaleString()}/year
              </div>
            </div>
          </div>
        )}
        ...
        {view==="subs"&&(
          <div>
            <div style={{...S.card,marginBottom:10}}>
              <div style={{...S.cardTitle,color:"#34d399"}}>👥 Active Subscribers — {Object.values(subscribers).filter(s=>s.active).length}</div>
              <div style={{fontSize:10,color:"#475569",marginBottom:10}}>Deactivated subscribers will lose app access on next app load. Use for non-payment or policy violations.</div>
              {Object.entries(subscribers).length===0&&<Empty icon="👥" text="No subscribers yet."/>}
              {Object.entries(subscribers).map(([id,sub])=>(
                <div key={id} style={{padding:"10px 0",borderBottom:"1px solid #1e293b"}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8}}>
                    <div style={{flex:1}}>
                      <div style={{display:"flex",alignItems:"center",gap:6}}>
                        <span style={{fontSize:13,fontWeight:"700",color:sub.active?"#34d399":"#ef4444"}}>{sub.active?"🟢":"🔴"} {sub.name||id}</span>
                      </div>
                      <div style={{fontSize:10,color:"#64748b"}}>{sub.mobile} · Expires: {sub.expiryDate}</div>
                      <div style={{fontSize:10,color:"#475569"}}>Via: {sub.source||"code"} · {sub.activatedAt?new Date(sub.activatedAt).toLocaleDateString("en-LK"):""}</div>
                      {!sub.active&&sub.deactivatedAt&&<div style={{fontSize:9,color:"#ef4444"}}>Deactivated: {new Date(sub.deactivatedAt).toLocaleDateString("en-LK")}</div>}
                      {/* Renewal alert */}
                      {sub.active&&sub.expiryDate&&(()=>{const daysLeft=Math.ceil((new Date(sub.expiryDate)-new Date())/(86400000));
                        return daysLeft<=30&&daysLeft>0?<div style={{fontSize:9,color:"#fbbf24",fontWeight:"700"}}>⚠️ Expires in {daysLeft} days</div>:null;})()}
                    </div>
                    <div style={{display:"flex",flexDirection:"column",gap:4,flexShrink:0}}>
                      {sub.active
                        ?<button onClick={()=>handleDeactivateSub(id)}
                            style={{background:"#7f1d1d",color:"#fca5a5",border:"none",borderRadius:6,padding:"4px 10px",fontSize:10,cursor:"pointer",fontWeight:"700"}}>
                            🚫 Deactivate
                          </button>
                        :<button onClick={()=>handleReactivateSub(id)}
                            style={{background:"#064e3b",color:"#6ee7b7",border:"none",borderRadius:6,padding:"4px 10px",fontSize:10,cursor:"pointer",fontWeight:"700"}}>
                            ✅ Reactivate
                          </button>
                      }
                      {/* Renewal reminder via WhatsApp */}
                      {sub.active&&sub.mobile&&(
                        <a href={`https://wa.me/94${(sub.mobile||"").replace(/^0/,"")}?text=${encodeURIComponent(`Dear ${sub.name||"Subscriber"}, your TaxCalc LK subscription expires on ${sub.expiryDate}. Please renew to continue access. Pay Rs.${SUBSCRIPTION_PRICE.toLocaleString()} to: Sampath Bank, ${BANK_DETAILS.accountNo} (${BANK_DETAILS.accountName}). WhatsApp us with slip for activation. — GDP Consultants`)}`}
                          target="_blank"
                          style={{background:"#064e3b",color:"#6ee7b7",border:"1px solid #10b981",borderRadius:6,padding:"4px 10px",fontSize:9,textDecoration:"none",textAlign:"center",fontWeight:"700"}}>
                          📩 Renewal WA
                        </a>
                      )}
                    </div>
            ...
            <div style={{fontSize:10,color:"#334155",textAlign:"center",padding:"8px"}}>
              💡 Send renewal reminders 30 days before expiry. Deactivated users see the upgrade screen.
            </div>
          </div>
        )}
...
// ─── STATUS BAR ────────────────────────────────────────────────────────────────
function StatusBar({trialDaysLeft,paidDaysLeft,profile,onEditProfile,onLogoTap,lang,setLang,activeYear,switchYear}){
  const renewalAlert = paidDaysLeft!==null && paidDaysLeft<=30 && paidDaysLeft>0;
  return(
    <>
    {renewalAlert&&(
      <div style={{background:"linear-gradient(135deg,#7f1d1d,#991b1b)",padding:"6px 12px",display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,flexShrink:0}}>
        <div style={{fontSize:10,color:"#fca5a5",fontWeight:"700"}}>
          ⚠️ Subscription expires in <b style={{color:"#fff"}}>{paidDaysLeft} days</b> — Renew to avoid interruption
        </div>
        <a href={`https://wa.me/94${APP_WHATSAPP.replace(/^0/,"")}?text=${encodeURIComponent(`Hello GDP Consultants, I need to renew my TaxCalc LK subscription. My name is ${profile?.name||""} and mobile is ${profile?.mobile||""}. Please provide renewal details.`)}`}
          target="_blank"
          style={{fontSize:9,background:"#fca5a5",color:"#7f1d1d",borderRadius:4,padding:"2px 6px",textDecoration:"none",fontWeight:"800",flexShrink:0}}>
          💬 Renew Now
        </a>
      </div>
    )}
...
function TransactionBook({data,update,cashBalance,totalBankBal,bankBalance,profile}){
  ...
  return(
    <div style={S.page}>
      ...
      <div style={S.pageHdr}><div style={S.pageTitle}>📒 Cash Book</div><button
...
// ─── INCOME PAGE ───────────────────────────────────────────────────────────────
// ─── INCOME SOURCES GUIDE COMPONENT ───────────────────────────────────────────
function IncomeSourcesGuide({activeYear, isFreelancer}) {
  const [tab, setTab] = React.useState("employment");
  const cfg = getTaxCfg(activeYear||"2025/2026");

  // All source data grouped by IRA section
  const SECTIONS = {
    employment: {
      label:"Employment", icon:"💼", color:"#3b82f6", bg:"#05101a",
      ...
      sources:[
        ...
        {icon:"🏢",name:"Non-Cash Benefits",          wht:null,    rate:"Imputed",    note:"Vehicle use, housing, meals — imputed market value included in assessable employment income"},
        {icon:"🎁",name:"Gratuity / Terminal",        wht:null,    rate:"Special",    note:"SPECIAL RATES: 0% on first Rs.10M · 6% next Rs.10M · 12% balance — s.7 IRA"},
        {icon:"🧓",name:"Pension from Employment",    wht:null,    rate:"APIT",       note:"Regular employer pension / ETF pension distributions — assessable employment income"},
        {icon:"📦",name:"ESOP / Share Scheme",        wht:null,    rate:"APIT",       note:"Employer share options/grants — assessable at market value on vest/exercise date"},
      ]
    },
    business: {
      label:"Business", icon:"🏪", color:"#f59e0b", bg:"#1a0e00",
      ref:"IRA Sections 11–17",
      desc:"Gains & profits from trade, business, profession or vocation — net of allowable expenses",
      sources:[
        {icon:"💻",name:"Freelance / Contract Fees",  wht:"5%",    rate:"WHT 5%",     note:"WHT 5% if payer is institution and monthly payment > Rs.150,000 from single payer — s.83 IRA"},
        {icon:"🏭",name:"Business / Trade Income",    wht:null,    rate:"IIT Rate",   note:"Gross business turnover. Deduct allowable expenses in Ledger. Net income assessed at progressive IIT rates"},
        {icon:"🩺",name:"Professional Practice",      wht:"5%",    rate:"WHT 5%",     note:"Doctor, lawyer, CA, engineer, architect practice fees — WHT 5% if payer is institution"},
        {icon:"💲",name:"Commission Income",          wht:"5%",    rate:"WHT 5%",     note:"Sales/agency commission — WHT 5% deducted at source by institution"},
        {icon:"📊",name:"Consulting Fees",            wht:"5%",    rate:"WHT 5%",     note:"WHT 5% if single-payer payment exceeds Rs.150,000/month"},
        {icon:"🌾",name:"Agriculture Income",         wht:null,    rate:"IIT/Exempt", note:"Small farmers may be exempt. Large-scale commercial agriculture is assessable business income"},
        {icon:"🤝",name:"Partnership Share of Profit",wht:null,    rate:"IIT Rate",   note:"Individual partner's share assessed at partner level — s.26 IRA. Partnership itself taxed at 0%/6%"},
      ]
    },
    investment: {
      label:"Investment", icon:"📈", color:"#10b981", bg:"#021a0e",
      ref:"IRA Sections 18–27",
      desc:"Gains from investment assets — interest, dividends, rent, royalties etc.",
      sources:[
    ...
    special: {
      label:"Special Rate", icon:"⚡", color:"#f97316", bg:"#1a0800",
      ref:"IRA Sections 40, 59",
    ...
    other: {
      label:"Other", icon:"💡", color:"#6366f1", bg:"#05050f",
      ref:"IRA Section 6",
      desc:"Other assessable income not classified under employment, business or investment",
      sources:[
        {icon:"🎰",name:"Lottery / Prize Winnings",   wht:null,    rate:"IIT Rate",   note:"Lottery, quiz, competition winnings — no automatic WHT. Assessable at progressive IIT rates"},
        {icon:"💫",name:"Casual / Irregular Income",  wht:null,    rate:"IIT Rate",   note:"One-off casual receipts — gifts exceeding reasonable value may be assessable. Include in return"},
        {icon:"💰",name:"Other Income",               wht:null,    rate:"IIT Rate",   note:"Any other income not classified above. Include in assessable income and apply progressive graduated rates"},
      ]
    },
  };

  const tabs = ["employment","business","investment","special","other"];
  const cur = SECTIONS[tab];

  return (
    <div style={{background:"linear-gradient(135deg,#050d1a,#071525)",border:"1px solid #1e3a5f",borderRadius:12,padding:12,marginBottom:12}}>
      <div style={{fontSize:11,fontWeight:800,color:"#93c5fd",marginBottom:6,letterSpacing:0.5}}>
        📋 IRD INCOME SOURCES GUIDE — {activeYear}
      </div>
      <div style={{fontSize:9,color:"#475569",marginBottom:8}}>
        All assessable income under IRA No.24/2017 (as amended). Personal Relief {activeYear}: Rs.{(getTaxCfg(activeYear).personalRelief/1e6).toFixed(1)}M · AIT on Interest: {(getTaxCfg(activeYear).aitRate*100).toFixed(0)}%
      </div>
      ...
      <div style={{display:"flex",gap:3,marginBottom:10,overflowX:"auto",paddingBottom:2}}>
        {tabs.map(t=>(
          <button key={t} onClick={()=>setTab(t)}
            style={{padding:"5px 8px",border:"none",borderRadius:6,cursor:"pointer",fontSize:9,fontWeight:700,whiteSpace:"nowrap",
              background:tab===t?SECTIONS[t].color+"30":"transparent",
              color:tab===t?SECTIONS[t].color:"#475569",
              borderBottom:tab===t?`2px solid ${SECTIONS[t].color}`:"2px solid transparent"}}>
            {SECTIONS[t].icon} {SECTIONS[t].label}
          </button>
        ))}
      </div>

      {/* Section header */}
      <div style={{fontSize:9,color:"#475569",marginBottom:6,padding:"4px 6px",background:cur.bg,borderRadius:6,borderLeft:`3px solid ${cur.color}`}}>
        <span style={{color:cur.color,fontWeight:700}}>{cur.ref}</span> — {cur.desc}
      </div>

      {/* Sources list */}
      {cur.sources.map(s=>(
        <div key={s.name} style={{display:"flex",gap:6,alignItems:"flex-start",padding:"5px 0",borderBottom:"1px solid #0d1e35"}}>
          <span style={{fontSize:14,minWidth:18}}>{s.icon}</span>
          <div style={{flex:1,minWidth:0}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:3}}>
              ...
              <span style={{fontSize:8,fontWeight:800,padding:"2px 5px",borderRadius:4,background:cur.color+"25",color:cur.color,whiteSpace:"nowrap"}}>{s.rate}</span>
            </div>
            <div style={{fontSize:9,color:"#475569",marginTop:2,lineHeight:1.4}}>{s.note}</div>
          </div>
        </div>
      ))}

      <div style={{marginTop:8,fontSize:8,color:"#334155",textAlign:"center",borderTop:"1px solid #1e293b",paddingTop:6}}>
        Source: Inland Revenue Act No.24 of 2017 · Amdt No.45/2022 · Amdt No.04/2023 · Amdt No.02/2025 · ird.gov.lk
      </div>
    </div>
  );
}
...
<div style="text-align:center;margin-top:16px">
  ...
  return(
    <div style={S.page}>
      <div style={S.pageTitle}>📊 Tax Report — {activeYear}</div>
...
// ──────────────────────────────────────────────────────────────────────────────
// APIT CALCULATOR PAGE — w.e.f. 2025/2026 (Table 01 & Table 05)
// ──────────────────────────────────────────────────────────────────────────────
function APTICalculatorPage() {
  const [salary,  setSalary]  = useState("");
  const [months,  setMonths]  = useState("12");
  const [changed, setChanged] = useState("no");
  const [result,  setResult]  = useState(null);
  const [apitYear, setApitYear] = useState("2025/2026");

  // Get Table 01 thresholds for selected year from TAX_YEAR_CONFIG
  // For 2023/2024 & 2024/2025: 6 bands × Rs.500k/12, monthly threshold Rs.100k
  // For 2025/2026: verified Table 01 from ird.gov.lk
  function getTable01Bands(yr) {
    const cfg = TAX_YEAR_CONFIG[yr];
    if (cfg && cfg.apitTable01) return cfg.apitTable01;
    // Fallback: derive from slabs using annual personal relief
    const relief = (cfg || TAX_YEAR_CONFIG["2025/2026"]).personalRelief;
    const mRelief = relief / 12;
    const slabs = (cfg || TAX_YEAR_CONFIG["2025/2026"]).slabs;
    let bands = [{ maxMonthly: mRelief, rate: 0, constant: 0, label: "Up to Rs." + mRelief.toLocaleString() + " — Nil" }];
    let cumTI = 0;
    slabs.forEach(s => {
      const bandAmt = s.max === Infinity ? Infinity : (s.max - s.min);
      const maxM = s.max === Infinity ? Infinity : mRelief + (s.max / 12);
      // Derive constant: tax at boundary of previous = rate × maxM - constant
      const prevBand = bands[bands.length - 1];
      // constant = rate × maxMonthly - (prevTax at prevBand.maxMonthly)
      let prevTax = prevBand.maxMonthly === Infinity ? 0 :
        (prevBand.rate * prevBand.maxMonthly - prevBand.constant);
      const constant = Math.round(s.rate * (mRelief + (s.min / 12)) - prevTax);
      bands.push({ maxMonthly: maxM, rate: s.rate, constant, label: "" });
    });
    return bands;
  }

  function calcT01(m, yr) {
    const bands = getTable01Bands(yr || apitYear);
    for (let b of bands) {
      if (m <= b.maxMonthly) return b.rate === 0 ? 0 : Math.max(0, b.rate * m - b.constant);
    }
    const last = bands[bands.length - 1];
    return Math.max(0, last.rate * m - last.constant);
  }
  ...
  function calcT05(cumIncome, yr) {
    ...
    for (const s of slabs) {
      if (taxable <= 0) break;
      const portion = Math.min(taxable, s.max === Infinity ? taxable : (s.max - s.min));
      tax += portion * s.rate;
      taxable -= portion;
    }
    // Recalculate cleanly
    let t2 = 0, rem = Math.max(0, cumIncome - relief);
    for (const s of slabs) {
      if (rem <= 0) break;
      const band = s.max === Infinity ? rem : Math.min(rem, s.max - s.min);
      t2 += band * s.rate;
      rem -= band;
    }
  ...
  function rs(x) { return "Rs " + x.toLocaleString("en-LK", {minimumFractionDigits: 2}); }

  function calculate() {
    const sal = parseFloat(salary);
    const mo  = parseInt(months);
    if (!sal || sal <= 0 || !mo || mo < 1 || mo > 12) return;

    if (changed === "no") {
      const monthlyTax = calcT01(sal, apitYear);
      const totalTax   = monthlyTax * mo;
      setResult({ type: "t01", sal, mo, monthlyTax, totalTax, yr: apitYear });
    } else {
      let rows = [], cum = 0, prevTax = 0;
      for (let m = 1; m <= mo; m++) {
        cum += sal;
        const cumTax  = calcT05(cum, apitYear);
        const mTax    = Math.max(0, cumTax - prevTax);
        rows.push({ m, cum, cumTax, mTax });
        prevTax = cumTax;
      }
      setResult({ type: "t05", sal, mo, rows, totalTax: prevTax, yr: apitYear });
    }
  }

  const tableStyle = {width:"100%", borderCollapse:"collapse", fontSize:11, marginTop:8};
  const thStyle    = {background:"#0e2240", color:"#93c5fd", padding:"6px 8px", border:"1px solid #1e3a5f", textAlign:"right", fontSize:10, fontWeight:700};
  const tdStyle    = {border:"1px solid #1e293b", padding:"5px 8px", textAlign:"right", color:"#cbd5e1", fontSize:11};
  const tdLStyle   = {...tdStyle, textAlign:"left"};

  // Dynamic SLABS from TAX_YEAR_CONFIG.apitTable01 for selected year
  function getT01Slabs(yr) {
    const cfg = TAX_YEAR_CONFIG[yr];
    if (!cfg || !cfg.apitTable01) {
      // Fallback 2025/2026
      return [
        ["Up to 150,000", "0%", "—"],
        ["150,001 – 233,333", "6%", "6% × Income – 9,000"],
        ["233,334 – 275,000", "18%", "18% × Income – 37,000"],
        ["275,001 – 316,667", "24%", "24% × Income – 53,500"],
        ["316,668 – 358,333", "30%", "30% × Income – 72,500"],
        ["Above 358,333", "36%", "36% × Income – 94,000"],
      ];
    }
    return cfg.apitTable01.map(b => {
      const rng = b.maxMonthly === Infinity ? `Above ${(b.maxMonthly === Infinity ? (cfg.apitTable01[cfg.apitTable01.length-2].maxMonthly+1).toLocaleString() : b.maxMonthly.toLocaleString())}` : b.label.split(":")[0];
      const formula = b.rate === 0 ? "—" : `${(b.rate*100).toFixed(0)}% × Income – ${b.constant.toLocaleString()}`;
      const rateLabel = b.rate === 0 ? "0%" : `${(b.rate*100).toFixed(0)}%`;
      return [b.label.split(":")[0].trim(), rateLabel, formula];
    });
  }

  function getT05Slabs(yr) {
    const cfg = TAX_YEAR_CONFIG[yr] || TAX_YEAR_CONFIG["2025/2026"];
    const relief = cfg.personalRelief;
    const slabs = cfg.slabs;
    let rows = [["Up to " + relief.toLocaleString(), "0%", "—"]];
    let cumMin = relief;
    slabs.forEach(s => {
      const cumMax = s.max === Infinity ? Infinity : relief + s.max;
      const rng = s.max === Infinity ? `Above ${(relief + s.min).toLocaleString()}` : `${(cumMin+1).toLocaleString()} – ${cumMax.toLocaleString()}`;
      // constant = rate * threshold_low - accumulated tax at threshold_low
      let accTax = 0, rem = s.min;
      for (const ss of slabs) {
        if (rem <= 0) break;
        const band = ss.max === Infinity ? rem : Math.min(rem, ss.max - ss.min);
        accTax += band * ss.rate;
        rem -= band;
      }
      const constant = Math.round(s.rate * (relief + s.min) - accTax);
      const formula = s.max === Infinity ? `${(s.rate*100).toFixed(0)}% × Income – ${constant.toLocaleString()}` : `${(s.rate*100).toFixed(0)}% × Income – ${constant.toLocaleString()}`;
      rows.push([rng, `${(s.rate*100).toFixed(0)}%`, formula]);
      cumMin = cumMax;
    });
    return rows;
  }

  const SLABS_T01 = getT01Slabs(apitYear);
  const SLABS_T05 = getT05Slabs(apitYear);

  return (
    <FinPage icon="🧾" title="APIT Calculator" subtitle={`Y/A ${apitYear} · Table 01 & Table 05 · IRD Sri Lanka`}>

      {/* ── INPUT FORM ── */}
      <div style={{background:F.gradCard, border:`1px solid ${F.borderAccent}`, borderRadius:14, padding:14, marginBottom:14}}>
        {/* Year Selector */}
        <div style={{marginBottom:12}}>
          <div style={{fontSize:11, color:F.textSecondary, marginBottom:4, fontWeight:600}}>Tax Year (Y/A)</div>
          <div style={{display:"flex", gap:6, flexWrap:"wrap"}}>
            {["2023/2024","2024/2025","2025/2026"].map(yr=>(
              <button key={yr} onClick={()=>{setApitYear(yr);setResult(null);}}
                style={{padding:"6px 12px", borderRadius:8, border:"none", cursor:"pointer", fontSize:11, fontWeight:700,
                  background: apitYear===yr ? "#7c3aed" : "#0a1428", color: apitYear===yr ? "#fff" : F.textMuted}}>
                {yr}
              </button>
            ))}
          </div>
          {apitYear==="2023/2024"&&<div style={{fontSize:10,color:"#94a3b8",marginTop:4}}>Relief Rs.1,200,000/yr · Threshold Rs.100,000/mo · Rates: 6%–36% (6 bands)</div>}
          {apitYear==="2024/2025"&&<div style={{fontSize:10,color:"#94a3b8",marginTop:4}}>Relief Rs.1,200,000/yr · Threshold Rs.100,000/mo · Rates: 6%–36% (6 bands)</div>}
          {apitYear==="2025/2026"&&<div style={{fontSize:10,color:"#34d399",marginTop:4}}>Relief Rs.1,800,000/yr · Threshold Rs.150,000/mo · Rates: 6%,18%,24%,30%,36% (12% eliminated)</div>}
        </div>
        <div style={{fontSize:12, fontWeight:700, color:F.accentSecond, marginBottom:12, letterSpacing:0.5}}>
          EMPLOYEE DETAILS
        </div>

        <div style={{marginBottom:10}}>
          <div style={{fontSize:11, color:F.textSecondary, marginBottom:4, fontWeight:600}}>Monthly Regular Salary (Rs)</div>
          <input
            type="number" value={salary} onChange={e=>setSalary(e.target.value)}
            placeholder="e.g. 250000"
            style={{width:"100%", background:"#060c1a", border:`1px solid ${F.borderAccent}`, borderRadius:8,
              padding:"9px 10px", color:F.textPrimary, fontSize:13, boxSizing:"border-box"}}
          />
        </div>

        <div style={{marginBottom:10}}>
          <div style={{fontSize:11, color:F.textSecondary, marginBottom:4, fontWeight:600}}>Months Employed (1–12)</div>
          <input
            type="number" value={months} min="1" max="12" onChange={e=>setMonths(e.target.value)}
            style={{width:"100%", background:"#060c1a", border:`1px solid ${F.borderAccent}`, borderRadius:8,
              padding:"9px 10px", color:F.textPrimary, fontSize:13, boxSizing:"border-box"}}
          />
        </div>
        ...
        <div style={{marginBottom:14}}>
          <div style={{fontSize:11, color:F.textSecondary, marginBottom:4, fontWeight:600}}>Changed employer / started mid-year?</div>
          <div style={{display:"flex", gap:8}}>
            {[["no","No — Same Employer"],["yes","Yes — Changed / Mid-Year"]].map(([v,lbl])=>(
              <button key={v} onClick={()=>setChanged(v)}
                style={{flex:1, padding:"8px 6px", borderRadius:8, border:"none", cursor:"pointer", fontSize:11, fontWeight:700,
                  background: changed===v ? (v==="yes"?"#7c3aed":"#0e7490") : "#0a1428",
                  color: changed===v ? "#fff" : F.textMuted}}>
                {lbl}
              </button>
            ))}
          </div>
          {changed==="yes" && (
            <div style={{fontSize:10, color:"#f59e0b", marginTop:5, padding:"6px 8px", background:"#1a0e00", borderRadius:6}}>
              ⚠️ Table 05 (cumulative method) will be applied as per IRD guidelines
            </div>
          )}
        </div>

        <button onClick={calculate}
          style={{width:"100%", padding:"11px", background:F.btnPrimary, border:"none", borderRadius:10,
      ...
      {result && (
        <>
          <div style={{background:"linear-gradient(135deg,#021a0e,#033d1a)", border:"1px solid #065f46", borderRadius:14, padding:14, marginBottom:12}}>
            <div style={{fontSize:12, fontWeight:800, color:"#34d399", marginBottom:10, letterSpacing:0.5}}>
              📊 APIT RESULT — {result.type==="t01" ? "TABLE 01 (Monthly Method)" : "TABLE 05 (Cumulative Method)"}
            </div>
            ...
            {result.type === "t01" ? (
              <>
                <table style={tableStyle}>
                  <tbody>
                    {[
                      ["Monthly Salary",        rs(result.sal)],
                      ["Months Employed",        result.mo],
                      ["Monthly Tax (Table 01)", rs(result.monthlyTax)],
                      ["Total APIT for Period",  rs(result.totalTax)],
                    ].map(([lbl,val])=>(
                      <tr key={lbl}>
                        <td style={tdLStyle}>{lbl}</td>
                        <td style={{...tdStyle, fontWeight:lbl.startsWith("Total")?"800":"400", color:lbl.startsWith("Total")?"#4ade80":tdStyle.color}}>{val}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                <div style={{marginTop:8, fontSize:12, color:F.textSecondary}}>
                  Effective monthly rate: <span style={{color:"#4ade80", fontWeight:700}}>
                    {result.sal > 0 ? (result.monthlyTax / result.sal * 100).toFixed(2) : "0.00"}%
                  </span>
                </div>
              </>
            ) : (
              <>
                <div style={{overflowX:"auto"}}>
                  <table style={tableStyle}>
                    <thead>
                      <tr>
                        {["Month","Cumulative Income","Cumulative Tax","Tax for Month"].map(h=>(
                    ...
                    <tbody>
                      {result.rows.map(r=>(
                        <tr key={r.m} style={{background: r.m % 2 === 0 ? "#07111f" : "transparent"}}>
                          <td style={{...tdStyle, textAlign:"center", color:"#93c5fd", fontWeight:600}}>{r.m}</td>
                          <td style={tdStyle}>{rs(r.cum)}</td>
                          <td style={tdStyle}>{rs(r.cumTax)}</td>
                          <td style={{...tdStyle, color: r.mTax > 0 ? "#fbbf24" : "#64748b", fontWeight: r.mTax > 0 ? 700 : 400}}>{rs(r.mTax)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div style={{marginTop:8, display:"flex", gap:12, flexWrap:"wrap"}}>
                  <div style={{fontSize:12, color:F.textSecondary}}>
                    Total APIT: <span style={{color:"#4ade80", fontWeight:800}}>{rs(result.totalTax)}</span>
                  </div>
                  <div style={{fontSize:12, color:F.textSecondary}}>
                    Effective rate: <span style={{color:"#4ade80", fontWeight:700}}>
                      {result.sal > 0 ? (result.totalTax / (result.sal * result.mo) * 100).toFixed(2) : "0.00"}%
                    </span>
                  </div>
                </div>
                <div style={{fontSize:10, color:"#f59e0b", marginTop:8, padding:"6px 8px", background:"#1a0e00", borderRadius:6}}>
                  ℹ️ Table 05 cumulative method applied — employer change or employment started mid-year
                </div>
              </>
            )}
          </div>
          ...
          <div style={{background:F.gradCard, border:`1px solid ${F.border}`, borderRadius:12, padding:12, marginBottom:12}}>
            <div style={{fontSize:11, fontWeight:800, color:F.accentGold, marginBottom:8}}>📋 Table 01 — Monthly Regular Income Slabs</div>
            <table style={tableStyle}>
              <thead>
                <tr>
                  {["Range (Rs)","Rate","Formula"].map(h=><th key={h} style={{...thStyle, textAlign:"left"}}>{h}</th>)}
                </tr>
              </thead>
              <tbody>
                {SLABS_T01.map(([rng,rate,formula], i)=>(
                  <tr key={i} style={{background: i%2===0?"#070e1e":"transparent"}}>
                    <td style={tdLStyle}>{rng}</td>
                    <td style={{...tdStyle, color:"#4ade80", fontWeight:700}}>{rate}</td>
                    <td style={{...tdLStyle, color:"#94a3b8", fontSize:10}}>{formula}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div style={{background:F.gradCard, border:`1px solid ${F.border}`, borderRadius:12, padding:12, marginBottom:12}}>
            <div style={{fontSize:11, fontWeight:800, color:F.accentSecond, marginBottom:8}}>📋 Table 05 — Cumulative Gains & Profits Slabs</div>
            <table style={tableStyle}>
              <thead>
                <tr>
                  {["Range (Rs)","Rate","Formula"].map(h=><th key={h} style={{...thStyle, textAlign:"left"}}>{h}</th>)}
              ...
              <tbody>
                {SLABS_T05.map(([rng,rate,formula], i)=>(
                  <tr key={i} style={{background: i%2===0?"#070e1e":"transparent"}}>
                    <td style={tdLStyle}>{rng}</td>
                    <td style={{...tdStyle, color:"#34d399", fontWeight:700}}>{rate}</td>
                    <td style={{...tdLStyle, color:"#94a3b8", fontSize:10}}>{formula}</td>
                  </tr>
                ))}
              </tbody>
      ...
      {/* ── INFO FOOTER ── */}
      <div style={{background:"#050d1a", border:"1px solid #1e3a5f", borderRadius:12, padding:10}}>
        <div style={{fontSize:10, color:"#475569", textAlign:"center", lineHeight:1.6}}>
          Source: IRD Sri Lanka · APIT Tables Y/A {apitYear} · Verified from ird.gov.lk{"\n"}
          Table 01 applies to regular monthly profits · Table 05 applies when employment starts mid-year or after a change of employer
        </div>
      </div>
    </FinPage>
  );
...
function CashBookReport({data, profile, activeYear, lang}){
  const [filterType,   setFilterType]   = useState("all");
  const [filterMonth,  setFilterMonth]  = useState("");
  const [filterMedium, setFilterMedium] = useState("all");
  const [downloading,  setDownloading]  = useState(false);

  const txns = [...(data.transactions||[])].sort((a,b)=>a.date.localeCompare(b.date));
  ...
  // Running balance (cash only)
  let runBal = (data.cashOpeningBalance||0);
  const rows = filtered.map(t=>{
    if(t.medium==="cash") runBal += t.type==="income" ? t.amount : -t.amount;
    return {...t, runBal};
  });
  ...
  filtered.forEach(t=>{
    const m = t.date.slice(0,7);
    if(!monthMap[m]) monthMap[m]={r:0,p:0};
    if(t.type==="income") monthMap[m].r+=t.amount; else monthMap[m].p+=t.amount;
  });
  const mList = Object.keys(monthMap).sort().reverse();

  // All unique months for filter dropdown
  const allMonths = [...new Set(txns.map(t=>t.date.slice(0,7)))].sort().reverse();

  const filterLabel  = filterMonth ? new Date(filterMonth+"-01").toLocaleDateString("en-LK",{month:"long",year:"numeric"}) : "All Periods";
  const typeLabel    = filterType==="all"?"All Transactions": filterType==="income"?"Income Only":"Expenses Only";
  const medLabel     = filterMedium==="all"?"Cash & Bank": filterMedium==="cash"?"Cash Only":"Bank Only";

  const downloadReport = ()=>{
    setDownloading(true);

    const txnRows = rows.map((t,i)=>`
      <tr>
        <td>${t.date}</td>
        <td>${(t.description||t.category).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</td>
        <td>${t.category}</td>
        <td style="text-transform:capitalize">${t.medium}</td>
        <td class="${t.type==="income"?"g":"r"}">${t.type==="income"?"+":"-"}Rs.${t.amount.toLocaleString("en-LK",{minimumFractionDigits:2})}</td>
        <td class="bal">Rs.${t.runBal.toLocaleString("en-LK",{minimumFractionDigits:2})}</td>
      </tr>`).join("");

    const mRows = mList.map(m=>`
      <tr>
        <td>${new Date(m+"-01").toLocaleDateString("en-LK",{month:"long",year:"numeric"})}</td>
        <td class="g">Rs.${monthMap[m].r.toLocaleString("en-LK",{minimumFractionDigits:2})}</td>
        <td class="r">Rs.${monthMap[m].p.toLocaleString("en-LK",{minimumFractionDigits:2})}</td>
        <td class="${monthMap[m].r-monthMap[m].p>=0?"g":"r"}">Rs.${(monthMap[m].r-monthMap[m].p).toLocaleString("en-LK",{minimumFractionDigits:2})}</td>
      </tr>`).join("");

    const html=`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>${APP_NAME} — Cash Book Report ${activeYear}</title>
<style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:Georgia,serif;background:#fff;color:#1a1a2e;padding:24px}
.header{display:flex;justify-content:space-between;align-items:flex-start;border-bottom:3px solid #b8960c;padding-bottom:16px;margin-bottom:20px}
.logo-area{display:flex;gap:14px;align-items:center}.logo-area img{width:70px;height:70px;border-radius:50%;border:2px solid #b8960c}
.firm{font-size:18px;font-weight:800;color:#1a1a2e}.sub{font-size:11px;color:#b8960c;font-weight:700;letter-spacing:1px;margin-top:2px}
...
.profile-box{background:#f8f9fa;border:1px solid #e2e8f0;border-radius:10px;padding:14px;margin-bottom:20px;display:grid;grid-template-columns:1fr 1fr;gap:8px}
.pf{font-size:12px;color:#374151}.pf span{color:#1a1a2e;font-weight:700}
.filter-box{background:#f0f4ff;border:1px solid #c7d2fe;border-radius:10px;padding:12px 16px;margin-bottom:20px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px}
.fl{font-size:10px;color:#6366f1;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:3px}
.fv{font-size:12px;font-weight:700;color:#1a1a2e}
...
.sum-in{background:#d1fae5;border:1px solid #10b981}.sum-out{background:#fee2e2;border:1px solid #ef4444}.sum-net{background:#dbeafe;border:1px solid #3b82f6}
.sum-label{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:6px}
.sum-in .sum-label{color:#065f46}.sum-out .sum-label{color:#991b1b}.sum-net .sum-label{color:#1e40af}
.sum-val{font-size:17px;font-weight:900}
.sum-in .sum-val{color:#059669}.sum-out .sum-val{color:#dc2626}.sum-net .sum-val{color:#1d4ed8}
table{width:100%;border-collapse:collapse;margin-bottom:20px;font-size:12px}
th{background:#1a1a2e;color:#fff;padding:9px 12px;text-align:left;font-size:11px;letter-spacing:0.5px}
td{padding:8px 12px;border-bottom:1px solid #f1f5f9}tr:nth-child(even)td{background:#fafafa}
.g{color:#059669;font-weight:600;text-align:right}.r{color:#dc2626;font-weight:600;text-align:right}
.bal{color:#1e40af;font-weight:700;text-align:right}
.section{font-size:14px;font-weight:800;color:#1a1a2e;margin:20px 0 10px;padding-left:6px;border-left:4px solid #b8960c}
.total-row td{background:#1a1a2e!important;color:#f5d060;font-weight:800;font-size:13px}
.total-row .g{color:#34d399}.total-row .r{color:#f87171}.total-row .bal{color:#60a5fa}
.disclaimer{background:#fef3c7;border:1px solid #fbbf24;border-radius:8px;padding:12px;font-size:11px;color:#78350f;margin-bottom:20px}
.footer{margin-top:30px;border-top:2px solid #b8960c;padding-top:16px;display:flex;justify-content:space-between;font-size:10px;color:#94a3b8}
@media print{body{padding:0}button{display:none}}
@media(max-width:600px){.filter-box,.summary-box{grid-template-columns:1fr}.header{flex-direction:column;gap:12px}table{font-size:10px}th,td{padding:6px 8px}}
</style></head><body>
<div class="header">
  <div class="logo-area">
    <img src="${LOGO_B64}" alt="GDP Consultants"/>
    <div>
      <div class="app-brand">${APP_NAME}</div>
      <div class="app-tag">${APP_BRAND_LINE}</div>
      <div class="firm" style="margin-top:4px">${FIRM_NAME}</div>
      <div style="font-size:11px;color:#555;margin-top:4px">✉ ${APP_EMAIL} · 🌐 ${APP_WEB} · 💬 ${APP_WHATSAPP}</div>
    </div>
  </div>
  <div>
    <div style="font-size:20px;font-weight:800;color:#b8960c">📒 Cash Book Report</div>
    <div style="font-size:13px;color:#64748b">Y/A ${activeYear} · ${filterLabel}</div>
    <div style="font-size:11px;color:#555;margin-top:4px">Generated: ${new Date().toLocaleDateString("en-LK")}</div>
  </div>
</div>
${profile?`<div class="profile-box">
  ...
  <div class="pf">NIC: <span>${profile.nic||"—"}</span></div>
  <div class="pf">TIN: <span>${profile.tin||"—"}</span></div>
  <div class="pf">Employment: <span>${profile.employmentType==="freelancer"?"💻 Freelancer":"🏢 Salaried"}</span></div>
  <div class="pf">Bank: <span>${profile.bankName||"—"}</span></div>
</div>`:""}
<div class="filter-box">
  <div><div class="fl">Period</div><div class="fv">${filterLabel}</div></div>
  <div><div class="fl">Type</div><div class="fv">${typeLabel}</div></div>
  <div><div class="fl">Medium</div><div class="fv">${medLabel}</div></div>
</div>
<div class="summary-box">
  <div class="sum-card sum-in"><div class="sum-label">Total Income</div><div class="sum-val">Rs.${totalIn.toLocaleString("en-LK",{minimumFractionDigits:2})}</div></div>
  <div class="sum-card sum-out"><div class="sum-label">Total Expenses</div><div class="sum-val">Rs.${totalOut.toLocaleString("en-LK",{minimumFractionDigits:2})}</div></div>
  <div class="sum-card sum-net"><div class="sum-label">Net Balance</div><div class="sum-val">Rs.${netBal.toLocaleString("en-LK",{minimumFractionDigits:2})}</div></div>
</div>
<div class="disclaimer">⚠️ <b>Disclaimer:</b> This report is generated from data entered in TaxCalc LK. Verify all figures with your GDP Consultants tax advisor before submission to IRD.</div>
<div class="section">📋 Transaction Details (${filtered.length} records)</div>
<table>
  <thead><tr><th>Date</th><th>Description</th><th>Category</th><th>Medium</th><th style="text-align:right">Amount</th><th style="text-align:right">Running Balance</th></tr></thead>
  <tbody>
    ${txnRows||`<tr><td colspan="6" style="text-align:center;padding:24px;color:#94a3b8">No transactions found for selected filters.</td></tr>`}
  </tbody>
  <tfoot>
    <tr class="total-row">
      <td colspan="4"><b>CLOSING BALANCE</b></td>
      <td class="${netBal>=0?"g":"r"}"><b>${netBal>=0?"+":""}Rs.${netBal.toLocaleString("en-LK",{minimumFractionDigits:2})}</b></td>
      <td class="bal"><b>Rs.${rows.length>0?rows[rows.length-1].runBal.toLocaleString("en-LK",{minimumFractionDigits:2}):"0.00"}</b></td>
    </tr>
  </tfoot>
</table>
<div class="section">📅 Monthly Summary</div>
<table>
  <thead><tr><th>Month</th><th style="text-align:right">Inflows (Rs.)</th><th style="text-align:right">Outflows (Rs.)</th><th style="text-align:right">Net (Rs.)</th></tr></thead>
  <tbody>
    ${mRows||`<tr><td colspan="4" style="text-align:center;padding:16px;color:#94a3b8">No data</td></tr>`}
  </tbody>
</table>
<div class="footer">
  <div>${APP_NAME} · ${FIRM_NAME}<br>Tax Year: ${activeYear} · Act: Inland Revenue (Amendment) Act No. 2 of 2025</div>
  <div style="text-align:right">Filing Deadline: ${FILING_DEADLINE}<br>Portal: ${IRD_PORTAL}</div>
</div>
<div style="text-align:center;margin-top:16px">
  <button onclick="window.print()" style="background:#1a1a2e;color:#f5d060;border:none;padding:10px 24px;border-radius:8px;font-size:14px;font-weight:700;cursor:pointer">🖨️ Print / Save as PDF</button>
</div>
    ...
    const a = document.createElement("a");
    a.href = url;
    a.download = `${APP_NAME}_CashBook_${activeYear.replace("/","_")}_${(profile?.name||"Report").replace(/\s+/g,"_")}_${filterMonth||"Full"}.html`;
    document.body.appendChild(a); a.click(); document.body.removeChild(a);
    URL.revokeObjectURL(url);
    setTimeout(()=>setDownloading(false), 1000);
  };
  ...
  return(
    <div style={S.page}>
      <div style={S.pageTitle}>📄 Cash Book Report — {activeYear}</div>

      {/* Download button — same style as Tax Report */}
      <button onClick={downloadReport} disabled={downloading}
        style={{width:"100%",padding:"13px",background:downloading?"#1e293b":"linear-gradient(135deg,#b8960c,#f5d060)",color:downloading?"#64748b":"#111",border:"none",borderRadius:12,fontWeight:"800",fontSize:14,cursor:downloading?"not-allowed":"pointer",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>
        {downloading?"⏳ Generating...":"📥 Download Full Cash Book Report (HTML → PDF)"}
      </button>
      <div style={{...S.card,border:"1px solid #064e3b",background:"#0a1a14",marginBottom:14,padding:"10px 12px"}}>
        <div style={{fontSize:11,color:"#6ee7b7",fontWeight:"700"}}>🖨️ How to get PDF</div>
        <div style={{fontSize:11,color:"#94a3b8",marginTop:4}}>Download the HTML file → open it in Chrome or Safari → tap Print → Save as PDF. Works on Android & iOS.</div>
      </div>

      {/* Filters */}
      <div style={{...S.card,border:"1px solid #0e3a52",background:F.surface,marginBottom:12}}>
        <div style={{...S.cardTitle,color:F.textSecondary}}>🔍 FILTER REPORT</div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8}}>
          <div>
            <label style={{...S.lbl,color:F.textMuted}}>Type</label>
            <select value={filterType} onChange={e=>setFilterType(e.target.value)} style={F.inp}>
          ...
          <div>
            <label style={{...S.lbl,color:F.textMuted}}>Medium</label>
            <select value={filterMedium} onChange={e=>setFilterMedium(e.target.value)} style={F.inp}>
        ...
        <div>
          <label style={{...S.lbl,color:F.textMuted}}>Month</label>
          <select value={filterMonth} onChange={e=>setFilterMonth(e.target.value)} style={F.inp}>
            <option value="">All Months</option>
            {allMonths.map(m=>(
              <option key={m} value={m}>{new Date(m+"-01").toLocaleDateString("en-LK",{month:"long",year:"numeric"})}</option>
            ))}
          </select>
        </div>
      </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:12}}>
        {[
          {label:"Total In",  val:fmt(totalIn),  color:"#34d399"},
          {label:"Total Out", val:fmt(totalOut), color:"#f87171"},
          {label:"Net",       val:fmt(netBal),   color:netBal>=0?"#60a5fa":"#f87171"},
        ].map((c,i)=>(
          <div key={i} style={{background:F.card,borderRadius:10,padding:"10px 8px",textAlign:"center",border:`1px solid ${c.color}33`}}>
            <div style={{fontSize:9,color:F.textMuted,marginBottom:4,fontWeight:"700"}}>{c.label}</div>
      ...
      {/* Transaction preview */}
      <div style={{...S.card,border:"1px solid #0e3a52",background:F.surface,padding:0,overflow:"hidden"}}>
        <div style={{padding:"10px 12px",borderBottom:"1px solid #0e3a52",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div style={{...S.cardTitle,color:F.textSecondary,marginBottom:0}}>TRANSACTIONS ({filtered.length})</div>
          <div style={{fontSize:10,color:F.textMuted}}>{filterLabel} · {medLabel}</div>
        </div>
        {filtered.length===0?(
          ...
          <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"9px 12px",borderBottom:"1px solid #0a1f2e"}}>
            <div style={{flex:1,minWidth:0}}>
              <div style={{fontSize:12,color:F.textPrimary,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{t.description||t.category}</div>
              <div style={{fontSize:9,color:F.textMuted,marginTop:1}}>{t.date} · {t.category} · <span style={{textTransform:"capitalize"}}>{t.medium}</span></div>
            </div>
            <div style={{fontSize:13,fontWeight:"700",color:t.type==="income"?"#34d399":"#f87171",flexShrink:0,marginLeft:8}}>
              {t.type==="income"?"+":"-"}{fmt(t.amount)}
            </div>
          </div>
        ))}
        {filtered.length>50&&(
          <div style={{padding:"10px",textAlign:"center",fontSize:11,color:F.textMuted,borderTop:"1px solid #0e3a52"}}>
            Showing first 50 of {filtered.length} — full list in downloaded report
          </div>
        )}
      </div>
    </div>
...
function ToolsPage({data, update, sub, lang, tax, profile}) {
  ...
  if(subTool==="apit")    return <><APTICalculatorPage /><BackBtn onClick={()=>setSubTool(null)}/></>;
  ...
  const TOOLS = [
    ...
    {
      id:"apit", icon:"🧾", title:"APIT Calculator 2025/26",
      desc:"Compute employee APIT using Table 01 (regular) or Table 05 (mid-year/changed employer) — IRD Sri Lanka",
      badge:"FREE", badgeColor:"#059669", tier:"Tier 1",
      accent:"#34d399", bg:"linear-gradient(135deg,#021a0e,#033d1a)",
    },
  ];
  ...
  return(
    <div style={{padding:"14px 14px 80px",background:F.base,minHeight:"100vh"}}>
      ...
      <div style={{fontSize:11,color:F.textMuted,marginBottom:4}}>10 powerful tools to plan, track & optimise your finances</div>
      ...
      <div style={{background:F.gradCard,borderRadius:12,border:`1px solid ${F.borderAccent}`,padding:14,marginTop:4}}>
        ...
        <a href="https://wa.me/94719204903?text=Hi+GDP+Consultants,+I'd+like+to+upgrade+my+TaxCalc+LK+plan."
          target="_blank" rel="noopener noreferrer"
...
function ServicesPage({profile,lang}){
  const [svcTab,setSvcTab]=React.useState("core");
  const coreServices=[
    ...
    {key:"aitr", icon:"🧾", urgentBadge:false, priceKey:"svc_aitr_price", titleKey:"svc_aitr", descKey:"svc_aitr_desc", color:"#34d399",border:"#065f46",bg:"linear-gradient(135deg,#010d08,#011a0f)",
      waMsg:"Hi GDP Consultants, I'd like help filing my Annual Income Tax Return (AITR)."},
    ...
    {key:"mgmt", icon:"📋", urgentBadge:false, priceKey:"svc_mgmt_price",  titleKey:"svc_mgmt", descKey:"svc_mgmt_desc", color:"#818cf8",border:"#3730a3",bg:"linear-gradient(135deg,#05050f,#0a0a20)",
      waMsg:"Hi GDP Consultants, I need quarterly management accounts for my business."},
  ];
  const additionalServices=[
    {key:"tp",   icon:"🌐", priceKey:"svc_tp_price",         titleKey:"svc_tp",         descKey:"svc_tp_desc",         color:"#6366f1",border:"#3730a3",bg:"linear-gradient(135deg,#05050f,#0a0a20)",
      waMsg:"Hi GDP Consultants, I need transfer pricing documentation for my business."},
    {key:"rentadv",icon:"🏠",priceKey:"svc_rental_adv_price",titleKey:"svc_rental_adv",  descKey:"svc_rental_adv_desc", color:"#f97316",border:"#9a3412",bg:"linear-gradient(135deg,#1a0800,#2d0f00)",
      waMsg:"Hi GDP Consultants, I need rental income tax advisory."},
    {key:"wht",  icon:"💹", priceKey:"svc_wht_price",        titleKey:"svc_wht",        descKey:"svc_wht_desc",        color:"#22d3ee",border:"#0e7490",bg:"linear-gradient(135deg,#01101a,#011a28)",
      waMsg:"Hi GDP Consultants, I need help claiming my WHT refund on interest/dividends."},
    {key:"fgn",  icon:"🌍", priceKey:"svc_foreign_price",    titleKey:"svc_foreign",    descKey:"svc_foreign_desc",    color:"#84cc16",border:"#3f6212",bg:"linear-gradient(135deg,#030c01,#081a02)",
      waMsg:"Hi GDP Consultants, I have export/foreign income and need tax guidance."},
    {key:"dd",   icon:"📊", priceKey:"svc_dd_price",         titleKey:"svc_dd",         descKey:"svc_dd_desc",         color:"#fb923c",border:"#9a3412",bg:"linear-gradient(135deg,#1a0800,#2d1000)",
      waMsg:"Hi GDP Consultants, I need a financial due diligence review."},
    {key:"bv",   icon:"📑", priceKey:"svc_bv_price",         titleKey:"svc_bv",         descKey:"svc_bv_desc",         color:"#e879f9",border:"#701a75",bg:"linear-gradient(135deg,#0f0015,#1a002a)",
      waMsg:"Hi GDP Consultants, I need a professional business valuation report."},
    {key:"ia",   icon:"🔒", priceKey:"svc_ia_price",         titleKey:"svc_ia",         descKey:"svc_ia_desc",         color:"#4ade80",border:"#166534",bg:"linear-gradient(135deg,#010d05,#011a08)",
      waMsg:"Hi GDP Consultants, I need an internal audit and controls review."},
    {key:"cos",  icon:"🤝", priceKey:"svc_cos_price",        titleKey:"svc_cos",        descKey:"svc_cos_desc",        color:"#60a5fa",border:"#1d4ed8",bg:"linear-gradient(135deg,#010820,#01103a)",
      waMsg:"Hi GDP Consultants, I need company secretarial services."},
    {key:"pkgfl",icon:"🧑‍💻",priceKey:"svc_pkg_fl_price",titleKey:"svc_pkg_fl",descKey:"svc_pkg_fl_desc",color:"#facc15",border:"#854d0e",bg:"linear-gradient(135deg,#1a1000,#2d1a00)",
      waMsg:"Hi GDP Consultants, I'm a freelancer and interested in the Freelancer Tax Package."},
    {key:"escnbt",icon:"🏭",priceKey:"svc_escnbt_price",     titleKey:"svc_escnbt",     descKey:"svc_escnbt_desc",     color:"#94a3b8",border:"#334155",bg:"linear-gradient(135deg,#050810,#0a0f1a)",
      waMsg:"Hi GDP Consultants, I need help with ESC/NBT compliance for prior years."},
  ];
  const services=svcTab==="core"?coreServices:additionalServices;
  const referralMsg=encodeURIComponent(`Hi GDP Consultants, I referred a friend to TaxCalc LK. My name is ${profile?.name||""} (${profile?.mobile||""}). Please add 1 free month to my account.`);
  return(
    <div style={S.page}>
      <div style={S.pageTitle}>💼 Our Services</div>
      <div style={{fontSize:11,color:"#64748b",marginBottom:10}}>Professional services from GDP Consultants · Book instantly via WhatsApp</div>
      <div style={{display:"flex",background:"#0a0d1a",border:"1px solid #1e293b",borderRadius:10,marginBottom:14,padding:3}}>
        {[{key:"core",label:"📌 Core Services"},{key:"additional",label:"⭐ Additional"}].map(t=>(
          <button key={t.key} onClick={()=>setSvcTab(t.key)}
            style={{flex:1,padding:"7px",border:"none",borderRadius:8,fontWeight:"700",fontSize:11,cursor:"pointer",
              background:svcTab===t.key?"linear-gradient(135deg,#1e3a5f,#1d4ed8)":"transparent",
              color:svcTab===t.key?"#93c5fd":"#475569"}}>
            {t.label}
          </button>
        ))}
      </div>

      {/* IRD Notice Urgent Banner (Core tab only) */}
      {svcTab==="core"&&(
      ...
      <div style={{...S.card,border:"1px solid #b8960c",background:"linear-gradient(160deg,#0d0d00,#1a1500)",marginTop:6}}>
        ...
        <div style={{fontSize:12,color:"#94a3b8",lineHeight:1.7,marginBottom:10}}>
          For every friend who subscribes to TaxCalc LK, you get <span style={{color:"#34d399",fontWeight:"700"}}>1 month FREE</span> added to your account.
        </div>
...
function DriveBackupGuide({onClose}){
  const steps=[
    ...
    {n:3,icon:"✅",color:"#10b981",title:"Allow Permissions",desc:"Grant TaxCalc LK permission to save files to your Drive. We only save backup files — we cannot read your other Drive files."},
    {n:4,icon:"📁",color:"#8b5cf6",title:"Backup Saved",desc:"A file named \"TaxCalcLK_Backup_YYYY-MM-DD.json\" appears in your Google Drive. Keep it safe — it has all your data."},
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",display:"flex",alignItems:"flex-end",zIndex:9999}}>
      <div style={{width:"100%",maxWidth:430,margin:"0 auto",background:"#0a0f1a",borderRadius:"20px 20px 0 0",padding:"20px 16px",maxHeight:"85vh",overflowY:"auto"}}>
        ...
        <div style={{background:"#0d1f3c",borderRadius:12,padding:"10px 12px",marginBottom:16,border:"1px solid #1d4ed8"}}>
          ...
          <div style={{fontSize:11,color:"#64748b",lineHeight:1.7}}>
            Your TaxCalc LK data is stored only on your phone. If you clear app data, uninstall, or switch phones — all your transactions, income records and tax data will be <strong style={{color:"#f87171"}}>permanently lost</strong>. Google Drive backup prevents this.
          </div>
        </div>
        {steps.map((s,i)=>(
...
function DriveBackupCard({profile,sub}){
  ...
  const gatherAllData=async()=>{
    const backup={version:12,createdAt:new Date().toISOString(),device:"TaxCalcLK App",profile:profile||null,data:{}};
  ...
  const backupToDrive=async()=>{
    ...
    try{
      ...
      const meta=JSON.stringify({name:filename,mimeType:"application/json",description:"TaxCalc LK backup — "+new Date().toLocaleString()});
    ...
    <>
      ...
      <div style={{...S.card,border:"1px solid #1d4ed8",background:"linear-gradient(160deg,#050c1f,#0a1535)",marginBottom:12}}>
        ...
        <div style={{fontSize:9,color:"#334155",marginTop:8,lineHeight:1.6,textAlign:"center"}}>
          🔒 Your data goes directly to YOUR Google Drive. TaxCalc LK never stores or sees your backup data.
        </div>
      </div>
    </>
  );
...
function HelpPage({tax,profile,sub,lang,setLang}){
  ...
  return(
    <div style={S.page}>
      ...
      <div style={{display:"flex",gap:5,overflowX:"auto",paddingBottom:6,marginBottom:14}}>
        {[["guide","📋","Guide"],["ird","🏛️","IRD Portal"],["steps","🪜","Steps"],["faq","❓","FAQ"],["backup","☁️","Backup"],["privacy","🔏","Privacy"],["contact","📞","Contact"]].map(([id,ico,lbl])=>(
        ...
        <>
          ...
          <div style={{background:"linear-gradient(135deg,#0a1535,#0d1f3c)",borderRadius:14,padding:"14px",border:"1px solid #1d4ed8",marginBottom:12}}>
            ...
            <div style={{fontSize:12,color:"#64748b",lineHeight:1.7}}>
              Your TaxCalc LK data lives only on this device. Backing up to Google Drive protects against phone loss, app reinstalls, and accidental data clearing.
            </div>
          </div>
          ...
          <div style={{...S.card,border:"1px solid #334155",background:"#080d18"}}>
            ...
            {[
              ...
              "TaxCalc LK never stores, transmits, or reads your backup data",
      ...
      {section==="privacy"&&(
        <>
          ...
          <div style={{background:"linear-gradient(135deg,#0a0f1e,#0d1527)",border:"1px solid #1e3a5f",borderRadius:14,padding:14,marginBottom:12}}>
            <div style={{fontSize:16,fontWeight:800,color:"#93c5fd",marginBottom:6}}>🔏 Privacy Policy</div>
            <div style={{fontSize:10,color:"#64748b",marginBottom:10}}>Effective Date: April 1, 2025 · GDP Consultants (Pvt) Ltd</div>
            <div style={{fontSize:11,color:"#64748b",lineHeight:1.7}}>
              TaxCalc LK is committed to protecting your financial privacy. This policy explains what data we collect, how it is used, and your rights.
            </div>
          </div>

          {/* Data Storage */}
          <div style={{...S.card,border:"1px solid #065f46",background:"#021a0e",marginBottom:10}}>
            <div style={{...S.cardTitle,color:"#34d399"}}>📱 Your Financial Data Stays on Your Device</div>
            <div style={{fontSize:11,color:"#94a3b8",lineHeight:1.8}}>
              <strong style={{color:"#e2e8f0"}}>TaxCalc LK does not maintain or store your transaction data on external servers.</strong><br/><br/>
              All financial information — including transactions, income records, tax calculations, and personal financial data — is stored locally on your device only. We never transmit, read, or have access to your financial data.
            </div>
          </div>

          {/* What We Collect */}
          <div style={{...S.card,border:"1px solid #1e293b",background:"#080d18",marginBottom:10}}>
            <div style={{...S.cardTitle,color:"#f5d060"}}>📋 What We Collect</div>
            {[
              {icon:"✅",title:"Subscription Status",desc:"We share your subscription activation status with admin only to verify your paid access. This includes: your name, mobile number, and expiry date."},
              {icon:"✅",title:"Google Drive Backup",desc:"If you use the backup feature, your data goes directly from your device to YOUR personal Google Drive. TaxCalc LK never sees or stores this data."},
              {icon:"❌",title:"Financial Transactions",desc:"Never collected. All transactions, income, tax entries stay on your device only."},
              {icon:"❌",title:"Bank Details or Passwords",desc:"Never collected. We have no access to any of your banking or financial account credentials."},
            ].map((item,i)=>(
              <div key={i} style={{display:"flex",gap:10,padding:"8px 0",borderBottom:"1px solid #1e293b"}}>
          ...
          {/* Your Rights */}
          <div style={{...S.card,border:"1px solid #1e293b",background:"#080d18",marginBottom:10}}>
            <div style={{...S.cardTitle,color:"#c4b5fd"}}>🛡️ Your Rights & Control</div>
            {[
              "Your financial data remains private and under your control at all times.",
              "You may delete all app data by uninstalling the app or clearing app storage.",
              "To delete your subscription record from admin records, contact us via WhatsApp.",
              "Google Drive backups can be deleted directly from your Google Drive.",
              "We do not sell, share, or monetise any personal or financial data.",
            ].map((item,i)=>(
              <div key={i} style={{display:"flex",gap:8,padding:"6px 0",borderBottom:"1px solid #1e293b",alignItems:"flex-start"}}>
          ...
          {/* Security */}
          <div style={{...S.card,border:"1px solid #1e293b",background:"#080d18",marginBottom:10}}>
            <div style={{...S.cardTitle,color:"#fbbf24"}}>🔒 Security</div>
            <div style={{fontSize:11,color:"#94a3b8",lineHeight:1.8}}>
              Subscription verification data is transmitted via HTTPS (encrypted). Google Drive backups use Google&apos;s OAuth2 security. We do not store payment card details — bank transfers are verified manually by admin.
            </div>
          </div>

          {/* Contact */}
          <div style={{...S.card,border:"1px solid #b8960c",background:"linear-gradient(160deg,#0d0d00,#1a1500)"}}>
            <div style={{...S.cardTitle,color:"#f5d060"}}>📬 Privacy Questions?</div>
            <div style={{fontSize:11,color:"#94a3b8",lineHeight:1.7,marginBottom:10}}>
              If you have questions about this Privacy Policy or wish to exercise your data rights, contact us:
            </div>
            <div style={{fontSize:12,fontWeight:700,color:"#f5d060"}}>GDP Consultants (Pvt) Ltd</div>
            <div style={{fontSize:11,color:"#64748b"}}>info@gdpconsultants.lk</div>
            <div style={{fontSize:11,color:"#64748b"}}>WhatsApp: {APP_WHATSAPP}</div>
          </div>
        </>
      )}
        ...
        <>
          ...
          <div style={{...S.card,border:"1px solid #1e3a5f",background:"#0a1525",marginBottom:14}}>
            ...
            <div style={{fontSize:10,color:"#334155",marginBottom:10,padding:"8px",background:"#050e1a",borderRadius:8,lineHeight:1.6}}>
              ...
              2. Mention: "I need to transfer my TaxCalc LK subscription to a new device"<br/>
              3. Provide your registered name & mobile number<br/>
              4. Google Play will recognise your subscription on the new device automatically<br/>
              5. If not, restore purchases via Play Store → Subscriptions
            </div>
            <a href={`https://wa.me/94${APP_WHATSAPP.replace(/^0/,"")}?text=Hello GDP Consultants, I need to transfer my TaxCalc LK subscription to a new device. My registered name is ${encodeURIComponent(profile?.name||"[your name]")} and mobile is ${profile?.mobile||"[your mobile]"}.`}
              target="_blank"
...
const catIcon=c=>({
  // Employment
  "Salary / Wages":"💼","Director's Fees":"🏦","Bonus / Incentive":"🎯","Overtime Pay":"⏰",
  "Non-Cash Benefits":"🏢","Gratuity / Terminal Benefits":"🎁","Pension from Employment":"🧓","ESOP / Share Scheme Gains":"📦",
  // Business
  "Freelance / Contract Fees":"💻","Business / Trade Income":"🏪","Professional Practice Income":"🩺",
  "Commission Income":"🤝","Consulting Fees":"🎓","Agriculture Income":"🌾","Partnership Share of Profit":"🤝",
  // Investment
  "Rental Income":"🏠","Dividends":"📊","Interest / FD Income":"🏦","Royalties":"📝",
  "Annuity / Private Pension":"🔄",
  // Special
  "Capital Gains":"📈","Export Services (15%)":"🌐","Foreign Remittance (15%)":"🌍",
  // Other
  "Lottery / Prize Winnings":"🎰","Casual / Irregular Income":"💫","Other Income":"💰",
  // Legacy
  Salary:"💼",Employment:"💼","Freelance/Contract":"💻","Business Income":"🏪",
  Rental:"🏠",Investment:"📈","Export/Foreign":"🌐",
}[c]||"💰");
