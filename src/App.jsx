...
const TAX_YEAR_CONFIG = {
  ...
  // ── 2022/2023 ── IRA No.24/2017 + Amendment No.45/2022
  // SPLIT YEAR: Period 1 (01.04.2022 – 31.12.2022) — Old IRA 2017 rates.
  //             Personal Relief Rs.3,000,000; 3-band progressive (6%/12%/18%).
  // Period 2 (01.01.2023 – 31.03.2023) — Amendment No.45/2022 kicked in:
  //             Personal Relief reduced to Rs.1,200,000; 6-band structure (6%–36%).
  // APIT threshold changed from Rs.250,000 to Rs.100,000/month from 01.01.2023.
  // App uses Amendment 45/2022 slabs (effective for Jan-Mar 2023 quarter).
  "2022/2023": {
    personalRelief:       1_200_000,   // Amendment No.45/2022 (from 01.01.2023)
    personalReliefOld:    3_000_000,   // Old period 01.04.2022 – 31.12.2022
    qpCap:                1_200_000,
    maxRefund:              180_000,
    filingThreshold:      1_200_000,   // Filing required if income > Rs.1,200,000 (new threshold)
    exportRate:                0.15,
    aitRate:                   0.05,   // AIT on interest was 5% in 2022/23
    aitDividendRate:           0.15,   // WHT on dividends 15%
    apitMonthlyThreshold:   100_000,   // New APIT threshold from 01.01.2023
    act: "IRA No.24/2017 + Amendment No.45/2022 (effective 01.01.2023)",
    splitYear: true,
    splitDate: "01 January 2023",
    // Period 2 (post Amendment No.45/2022) slabs — 6 bands × Rs.500,000
    slabs: [
    ...
    // Period 1 (pre-Amendment) slabs — Old IRA 2017 3-band structure
    slabsOld: [
      { min:0,         max:3_000_000, rate:0.06, label:"First Rs.3,000,000 @ 6%"     },
      { min:3_000_000, max:6_000_000, rate:0.12, label:"Next Rs.3,000,000 @ 12%"     },
      { min:6_000_000, max:Infinity,  rate:0.18, label:"Balance above Rs.6M @ 18%"   },
    ],
    notes: [
      "⚠️ SPLIT YEAR — Two tax regimes apply for Y/A 2022/2023",
      "Period 1 (01.04.2022 – 31.12.2022): Personal Relief Rs.3,000,000 · Old 3-band IRA 2017 rates (6%/12%/18%) · APIT threshold Rs.250,000/month",
      "Period 2 (01.01.2023 – 31.03.2023): Amendment No.45/2022 — Personal Relief reduced to Rs.1,200,000 · New 6-band structure (6% to 36%) · APIT threshold Rs.100,000/month",
      "AIT on FD interest: 5% (creditable) | WHT on dividends: 15%",
      "Export/foreign income: 15% flat rate",
      "Capital gains on disposal of investment assets: 10%",
      "Mandatory AITR filing if gross income > Rs.1,200,000 (new period) or Rs.3,000,000 (old period)",
      "Source: IRA No.24 of 2017 as amended by Amendment Act No.45 of 2022",
    ],
  },

  // ── 2023/2024 ── Amendment No.45/2022 fully in effect (01.04.2023 – 31.03.2024)
  // Personal Relief: Rs.1,200,000. APIT from Rs.100,000/month.
  // 6-band progressive structure (6% × 500k, 12% × 500k … 36% balance).
  // Cash transaction limit Rs.500,000+ must be via bank/card (Amendment No.4/2023).
  "2023/2024": {
    ...
    exportRate:                0.15,
    aitRate:                   0.05,   // AIT on FD interest: 5%
    ...
    notes: [
      "Personal relief Rs.1,200,000 — Amendment No.45/2022 fully in effect",
      "Mandatory AITR filing if gross income > Rs.1,200,000",
      "APIT employer threshold: Rs.100,000/month (= Rs.1,200,000/12)",
      "AIT on FD interest: 5% | WHT on dividends: 15% (creditable against final IIT)",
      "Capital gains on disposal of investment assets: 10% (CGT)",
      "Listed company share gains: EXEMPT from CGT",
      "Cash transactions ≥ Rs.500,000 must be via bank/card — Amendment No.4/2023",
      "Export/foreign income: 15% flat rate under s.59 IRA",
      "Qualifying payments deduction: max Rs.1,200,000",
      "Source: IRA No.24 of 2017 + Amdt No.45/2022 + Amdt No.04/2023",
    ],
  },

  // ── 2024/2025 ── Budget 2024 — IRA Amendment effective 01.04.2024
  // Personal Relief: Rs.1,200,000 (UNCHANGED from 2023/24).
  // Slab structure UNCHANGED — 6 bands × Rs.500,000 (6% to 36%).
  // IRD Compliance Ruling 2024/01: Transfer pricing docs now mandatory.
  // AIT on interest REMAINS 5%. APIT threshold remains Rs.100,000/month.
  "2024/2025": {
    personalRelief:       1_200_000,
    qpCap:                1_200_000,
    maxRefund:              180_000,
    filingThreshold:      1_200_000,
    exportRate:                0.15,
    aitRate:                   0.05,   // AIT on interest still 5% in 2024/25
    aitDividendRate:           0.15,
    apitMonthlyThreshold:   100_000,
    act: "IRA No.24/2017 + Amendment No.45/2022 (Y/A 2024/2025)",
    slabs: [
      { min:0,         max:  500_000, rate:0.06, label:"First Rs.500,000 @ 6%"       },
      { min:  500_000, max:1_000_000, rate:0.12, label:"Next Rs.500,000 @ 12%"       },
      { min:1_000_000, max:1_500_000, rate:0.18, label:"Next Rs.500,000 @ 18%"       },
    ...
    notes: [
      "Personal relief Rs.1,200,000 — unchanged from 2023/24",
      "Mandatory AITR filing if gross income > Rs.1,200,000",
      "APIT employer threshold: Rs.100,000/month",
      "AIT on interest: 5% | WHT on dividends: 15%",
      "Refund claims must be applied within 30 months of year-end (from Y/A 2024/25)",
      "IRD Compliance Ruling 2024/01: Transfer pricing documentation now mandatory",
      "Capital gains: 10% on investment asset disposals",
      "Export/foreign income: 15% flat rate",
      "Source: IRA No.24 of 2017 + Amendment No.45/2022",
    ],
  },

  // ── 2025/2026 ── Inland Revenue (Amendment) Act No.02 of 2025 — effective 01.04.2025
  // KEY CHANGES: Personal Relief INCREASED to Rs.1,800,000 (from Rs.1,200,000).
  // 6% slab WIDENED from Rs.500,000 to Rs.1,000,000.
  // 12% band ELIMINATED — progressive rates jump from 6% directly to 18%.
  // AIT on interest INCREASED from 5% to 10%.
  // Export/foreign income exemption REMOVED — taxed at 15% flat.
  // Betting/gaming/tobacco/liquor tax rate increased to 45%.
  // Source: IRD Notice PN/IT/2025-01 dated 26.03.2025 | Act No.02 of 2025 certified 20.03.2025
  "2025/2026": {
    personalRelief:       1_800_000,   // Increased from Rs.1,200,000
    qpCap:                1_200_000,
    maxRefund:              180_000,
    filingThreshold:      1_800_000,
    exportRate:                0.15,   // 15% flat (exemption removed by Act No.2/2025)
    aitRate:                   0.10,   // AIT on interest INCREASED to 10% (was 5%)
    aitDividendRate:           0.15,
    ...
    slabs: [
      // NOTE: 12% band ELIMINATED in 2025/2026 — rates jump from 6% to 18%
    ...
    notes: [
      "✅ Personal relief INCREASED to Rs.1,800,000 (was Rs.1,200,000) — Act No.02/2025",
      "✅ First slab widened: 6% applies to first Rs.1,000,000 (was Rs.500,000)",
      "⚠️ 12% band ELIMINATED — progressive rates: 6%, 18%, 24%, 30%, 36%",
      "⚠️ AIT on FD interest INCREASED to 10% (was 5%) — effective 01.04.2025",
      "⚠️ Export/foreign income exemption REMOVED — taxed at 15% flat (Act No.2/2025)",
      "APIT employer threshold: Rs.150,000/month (= Rs.1,800,000/12)",
      "Mandatory AITR filing if gross income > Rs.1,800,000",
      "Refund (excess APIT) up to Rs.180,000 processed within 3 months before audit",
      "Senior citizens: quarterly refund up to Rs.45,000 without audit",
      "Betting/gaming/tobacco/liquor: flat 45% rate (increased from 40%)",
      "Source: IRD Notice PN/IT/2025-01 | Amdt Act No.02 of 2025 certified 20.03.2025",
    ],
  },

  // ── 2026/2027 ── Same structure as 2025/2026 (Budget 2026 not yet enacted)
  // Rates are provisional — verify with IRD.gov.lk before filing.
  "2026/2027": {
    ...
    notes: [
      "⚠️ Rates provisional — Budget 2026 not yet enacted. Based on Act No.02/2025.",
      "Personal relief Rs.1,800,000 | APIT threshold Rs.150,000/month",
      "Please verify at ird.gov.lk before filing your 2026/2027 tax return",
    ],
  },
};
...
const INCOME_CATS_SALARIED = [
  "Salary / Wages",           // Employment — APIT deducted by employer
  "Director's Fees",          // WHT 5% at source
  "Bonus / Incentive",        // Part of employment income — APIT applies
  "Non-Cash Benefits",        // Vehicle, housing, meals — imputed value taxable
  "Rental Income",            // AIT 10% if payer is institution
  "Dividends",                // AIT 15% deducted at source
  "Interest / FD Income",     // AIT 10% (from 01.04.2025; was 5% pre-2025/26)
  "Royalties",                // WHT 10% at source
  "Capital Gains",            // 10% CGT on investment asset disposals
  "Export Services (15%)",    // 15% flat — foreign currency remitted to SL bank
  "Foreign Remittance (15%)", // 15% flat — foreign-sourced income remitted to SL
  "Other Income",             // Casual, irregular, not captured above
];
const INCOME_CATS_FREELANCER = [
  "Freelance / Contract Fees", // Professional service — WHT 5% if payer is institution
  "Business / Trade Income",   // Sole trader, professional practice
  "Commission Income",         // WHT 5% at source
  "Consulting Fees",           // WHT 5% if > Rs.150,000/month from single payer
  "Rental Income",             // AIT 10% if payer is institution
  "Dividends",                 // AIT 15% deducted at source
  "Interest / FD Income",      // AIT 10% (from 01.04.2025)
  "Royalties",                 // WHT 10% at source
  "Capital Gains",             // 10% CGT on investment asset disposals
  "Export Services (15%)",     // 15% flat — service exports in foreign currency
  "Foreign Remittance (15%)",  // 15% flat — foreign-sourced income
  "Other Income",              // Casual, irregular, not captured above
];

// WHT/AIT metadata per income category (for display guidance)
const INCOME_CAT_META = {
  "Salary / Wages":            { wht: null,   note: "APIT deducted by employer monthly" },
  "Director's Fees":           { wht: "5%",   note: "WHT 5% deducted at source by company" },
  "Bonus / Incentive":         { wht: null,   note: "Included in employment income — APIT applies" },
  "Non-Cash Benefits":         { wht: null,   note: "Imputed value included in assessable employment income" },
  "Rental Income":             { wht: "10%",  note: "AIT 10% if tenant is institution/company" },
  "Dividends":                 { wht: "15%",  note: "AIT 15% deducted at source — included in assessable income" },
  "Interest / FD Income":      { wht: "10%",  note: "AIT 10% (from 01.04.2025; was 5% in prior years)" },
  "Royalties":                 { wht: "10%",  note: "WHT 10% deducted at source" },
  "Capital Gains":             { wht: "10%",  note: "10% CGT on disposal of investment assets (unlisted shares taxable; listed EXEMPT)" },
  "Export Services (15%)":     { wht: "15%",  note: "15% flat tax — service exports in foreign currency remitted to SL bank" },
  "Foreign Remittance (15%)":  { wht: "15%",  note: "15% flat — foreign-sourced income remitted to Sri Lanka via bank" },
  "Other Income":              { wht: null,   note: "Include in assessable income at applicable graduated rate" },
  "Freelance / Contract Fees": { wht: "5%",   note: "WHT 5% if payer is institution & payment > Rs.150,000/month" },
  "Business / Trade Income":   { wht: null,   note: "Net income after allowable expenses — progressive IIT rates" },
  "Commission Income":         { wht: "5%",   note: "WHT 5% at source" },
  "Consulting Fees":           { wht: "5%",   note: "WHT 5% if single-payer payment > Rs.150,000/month" },
};

const TXN_CATS_INCOME  = ["Salary/Employment","Director's Fees","Freelance Receipt","Business Receipt","Commission","Consulting Fees","Rental Receipt","Dividend","FD Interest","Royalty","Capital Gain","Export Receipt","Foreign Remittance","Bonus","Refund","Other Receipt"];
...
function computeTax(profile, incomeEntries, expenseEntries, taxSettings, activeYear) {
  ...
  const slIncome     = totalGross - exportIncome - capitalGainsIncome;
  ...
  const grossTax   = gradTax + exportTax + capitalGainsTax;
  ...
  return {
    taxable, slIncome, netIncome, relief, qpRelief, grossTax, exportTax, capitalGainsTax, capitalGainsIncome, apitPaid, netTax,
...
function IncomePage({data,update,tax,profile,incomeCats,activeYear}){
  ...
  {showForm ? "✕" : (data.incomeEntries.length===0 ? "✨ Add Income" : "+ Add")}
      ...
      <div style={{background:"linear-gradient(135deg,#050d1a,#071525)",border:"1px solid #1e3a5f",borderRadius:12,padding:12,marginBottom:12}}>
        <div style={{fontSize:11,fontWeight:800,color:"#93c5fd",marginBottom:8,letterSpacing:0.5}}>📋 IRD INCOME SOURCES — {activeYear}</div>
        <div style={{fontSize:10,color:"#475569",marginBottom:8}}>All assessable income under IRA No.24/2017. Add each source separately for accurate tax computation.</div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:4}}>
          {[
            ["💼","Salary / Wages","APIT by employer"],
            ["🏦","Director's Fees","WHT 5%"],
            ["🎯","Bonus / Incentive","APIT by employer"],
            ["🏢","Non-Cash Benefits","Imputed value"],
            ["🏠","Rental Income","AIT 10%"],
            ["📊","Dividends","AIT 15%"],
            ["🏦","Interest / FD Income","AIT 10% (2025+)"],
            ["📝","Royalties","WHT 10%"],
            ["📈","Capital Gains","CGT 10%"],
            ["🌐","Export Services","15% flat"],
            ["🌍","Foreign Remittance","15% flat"],
            ["💰","Other Income","Graduated IIT"],
          ].map(([icon,name,rate])=>(
            <div key={name} style={{display:"flex",gap:5,alignItems:"center",padding:"3px 0"}}>
              <span style={{fontSize:11}}>{icon}</span>
              <div style={{flex:1,minWidth:0}}>
                <div style={{fontSize:9,color:"#94a3b8",lineHeight:1.2,fontWeight:600}}>{name}</div>
                <div style={{fontSize:8,color:"#475569"}}>{rate}</div>
              </div>
            </div>
          ))}
        </div>
        <div style={{marginTop:8,fontSize:9,color:"#334155",textAlign:"center"}}>
          Source: IRD Sri Lanka · Act No.24/2017 + Amendment Act No.02/2025 · ird.gov.lk
        </div>
      </div>
      ...
      {showForm&&(
        <FormCard title="Add Income Entry">
          ...
          {/* APIT field for salary/employment */}
          {(form.category==="Salary / Wages"||form.category==="Bonus / Incentive"||form.category==="Non-Cash Benefits")&&(
  ...
  return(
    <div style={S.page}>
      ...
      <div style={{...S.card,border:"1px solid #b8960c",background:"linear-gradient(160deg,#0d0d00,#1a1500)"}}>
        ...
        {tax.exportIncome>0&&<><div style={S.divider}/><TRow l="Export/Service/Foreign Income Tax (15% flat)" v={fmt(tax.exportTax)} c="#f59e0b"/></>}
      ...
      <div style={{...S.card,background:"#050c18",border:"1px solid #1e3a5f"}}>
            ...
            <div key={yk} style={{marginBottom:10,border:`1px solid ${isCurrent?"#b8960c":"#1e293b"}`,borderRadius:10,overflow:"hidden"}}>
              ...
              <div style={{padding:"8px 12px",background:"#040a14"}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:"2px 16px"}}>
                  ...
                  <span style={{fontSize:10,fontWeight:700,color:"#a78bfa",textAlign:"right"}}>15% flat</span>
                ...
                {c.splitYear&&(
                  <div style={{marginTop:6,padding:"5px 8px",background:"#12041a",border:"1px solid #6d28d9",borderRadius:6}}>
                    <div style={{fontSize:9,color:"#a78bfa",fontWeight:700,marginBottom:3}}>PERIOD 1 (01.04.2022 – 31.12.2022) — Old IRA 2017 Rates:</div>
                    {(c.slabsOld||[]).map((s,i)=>(
                    ...
                    <div style={{fontSize:9,color:"#6d28d9",marginTop:3}}>Personal Relief: Rs.3,000,000 | APIT threshold: Rs.250,000/month</div>
                  </div>
                )}
              </div>
            </div>
        ...
        <div style={{marginTop:8,padding:"10px",background:"#07101a",borderRadius:8,border:"1px solid #1e3a5f"}}>
          ...
          {[
            ["Dividends","15%","All years","AIT deducted by company at distribution"],
            ["FD / Bank Interest","5%","Up to 2024/25","AIT — resident individual claim credit"],
...
function APTICalculatorPage() {
  ...
  // Table 01 — Monthly Regular Profits
  function calcT01(m) {
    if (m <= 150000)       return 0;
    if (m <= 233333)       return Math.max(0, 0.06 * m - 9000);
    if (m <= 275000)       return Math.max(0, 0.18 * m - 37000);
    if (m <= 316667)       return Math.max(0, 0.24 * m - 53500);
    if (m <= 358333)       return Math.max(0, 0.30 * m - 72500);
    return Math.max(0, 0.36 * m - 94000);
  }

  // Table 05 — Cumulative Gains & Profits
  function calcT05(c) {
    if (c <= 1800000)      return 0;
    if (c <= 2800000)      return Math.max(0, 0.06 * c - 108000);
    if (c <= 3300000)      return Math.max(0, 0.18 * c - 444000);
    if (c <= 3800000)      return Math.max(0, 0.24 * c - 642000);
    if (c <= 4300000)      return Math.max(0, 0.30 * c - 870000);
    return Math.max(0, 0.36 * c - 1128000);
  }
  ...
  function calculate() {
    ...
    if (changed === "no") {
      const monthlyTax = calcT01(sal);
      const totalTax   = monthlyTax * mo;
      setResult({ type: "t01", sal, mo, monthlyTax, totalTax });
    } else {
      let rows = [], cum = 0, prevTax = 0;
      for (let m = 1; m <= mo; m++) {
        cum += sal;
        const cumTax  = calcT05(cum);
        const mTax    = Math.max(0, cumTax - prevTax);
        rows.push({ m, cum, cumTax, mTax });
        prevTax = cumTax;
      }
      setResult({ type: "t05", sal, mo, rows, totalTax: prevTax });
    }
  }
  ...
  const SLABS_T05 = [
    ["Up to 1,800,000",       "0%",  "—"],
    ["1,800,001 – 2,800,000", "6%",  "6% × Income – 108,000"],
    ["2,800,001 – 3,300,000", "18%", "18% × Income – 444,000"],
    ["3,300,001 – 3,800,000", "24%", "24% × Income – 642,000"],
    ["3,800,001 – 4,300,000", "30%", "30% × Income – 870,000"],
    ["Above 4,300,000",        "36%", "36% × Income – 1,128,000"],
  ];

  return (
    <FinPage icon="🧾" title="APIT Calculator" subtitle="w.e.f. 2025/2026 · Table 01 & Table 05 · IRD Sri Lanka">
      ...
      <div style={{background:"#050d1a", border:"1px solid #1e3a5f", borderRadius:12, padding:10}}>
        <div style={{fontSize:10, color:"#475569", textAlign:"center", lineHeight:1.6}}>
          Source: IRD Sri Lanka · APIT Tables w.e.f. 2025/2026{"\n"}
...
const catIcon=c=>({
  "Salary / Wages":"💼","Director's Fees":"🏦","Bonus / Incentive":"🎯","Non-Cash Benefits":"🏢",
  "Rental Income":"🏠","Dividends":"📊","Interest / FD Income":"🏦","Royalties":"📝",
  "Capital Gains":"📈","Export Services (15%)":"🌐","Foreign Remittance (15%)":"🌍","Other Income":"💰",
  "Freelance / Contract Fees":"💻","Business / Trade Income":"🏪","Commission Income":"🤝","Consulting Fees":"🎓",
  // legacy
